...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(od) // Defines NN_Instance_od and NN_Interface_od with network.c info

AI_ALIGNED(32)
static ai_u8 activations_1[0];
AI_ALIGNED(32)
static ai_u8 activations_2[351232];
AI_ALIGNED(32)
...
AI_ALIGNED(32)
static ai_u8 weights_6[11053488];
AI_ALIGNED(32)
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_od);
  }
}
