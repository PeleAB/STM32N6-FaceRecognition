...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(faceid) // Defines NN_Instance_faceid and NN_Interface_faceid with network.c info

AI_ALIGNED(32)
static ai_u8 activations_1[229376];
AI_ALIGNED(32)
...
AI_ALIGNED(32)
static ai_u8 activations_5[3211264];
AI_ALIGNED(32)
...
AI_ALIGNED(32)
static ai_u8 weights_6[1092129];
AI_ALIGNED(32)
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_faceid);
  }
}
