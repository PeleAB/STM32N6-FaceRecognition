...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(reid) // Defines NN_Instance_reid and NN_Interface_reid with network.c info
...
AI_ALIGNED(32)
static ai_u8 weights_6[2432337];
AI_ALIGNED(32)
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_reid);
  }
}
