...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(fd) // Defines NN_Instance_fd and NN_Interface_fd with network.c info
...
AI_ALIGNED(32)
static ai_u8 weights_6[2030881];
AI_ALIGNED(32)
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_fd);
  }
}
