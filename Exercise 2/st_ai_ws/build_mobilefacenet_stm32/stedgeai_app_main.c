...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(mobilefacenet_stm32) // Defines NN_Instance_mobilefacenet_stm32 and NN_Interface_mobilefacenet_stm32 with network.c info
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_mobilefacenet_stm32);
  }
}
