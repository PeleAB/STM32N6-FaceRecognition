...
#define USBD_MANUFACTURER_STRING      "STMicroelectronics"
#define USBD_PRODUCT_HS_STRING        "STM32 USB in HS Mode"
#define USBD_CONFIGURATION_HS_STRING  "STM32 USB HS Config"
#define USBD_INTERFACE_HS_STRING      "STM32 USB HS Interface"
