...
#else
void    usbx_ux_host_class_hid_idle_set_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_idle_set Test............................. ");
...
UINT status;
    ...
    status = _ux_host_class_hid_idle_set(hid, 0, 0);
    ...
    status = _ux_host_class_hid_idle_set(UX_NULL, 0, 0);
