...
static UX_HOST_CLASS_SWAR           *host_swar = UX_NULL;
...
static unsigned char device_framework_full_speed[] = {
    ...
    */
    ...
    _INTERFACE_DESCRIPTOR(0, 0, 1, 0xFF, 0xFF, 0x00)
...
UX_HOST_CLASS_SWAR *swar_inst = (UX_HOST_CLASS_SWAR *) inst;
...
#else
void    usbx_msrc_81233_host_swar_inst_free_tests_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                  memory_pointer;
    ...
    printf("Running MSRC 81233 - Host SWAR inst free Test....................... ");
    ...
    status =  ux_host_stack_class_register(_ux_system_host_class_swar_name, _ux_host_class_swar_entry);
...
{
    if (device_dummy == UX_NULL && host_swar == UX_NULL)
        return(UX_SUCCESS);
    return(UX_ERROR);
}
