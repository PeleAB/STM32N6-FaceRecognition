...
#else
void    usbx_ux_device_stack_alternate_setting_get_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_HID_PARAMETER    hid_parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_alternate_setting_get Test.................. ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_alternate_setting_get Test.................. ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_alternate_setting_get Test.................. ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_alternate_setting_get Test.................. ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_alternate_setting_get Test.................. ERROR #6\n");
        test_control_return(1);
    }
#endif
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_alternate_setting_get Test.................. ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_alternate_setting_get Test.................. ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_alternate_setting_get Test.................. ERROR #8\n");
        test_control_return(1);
    }
}
...
UX_SLAVE_INTERFACE      *interface;
    ...
    /* Inform user.  */
    printf("Running ux_device_stack_alternate_setting_get Test.................. ");
    ...
    device -> ux_slave_device_first_interface = UX_NULL;
    status = _ux_device_stack_alternate_setting_get(0);
    if (status == UX_SUCCESS)
    {

        printf("ERROR #%d: expect error in case no interface\n", __LINE__);
        error_counter ++;
    }
