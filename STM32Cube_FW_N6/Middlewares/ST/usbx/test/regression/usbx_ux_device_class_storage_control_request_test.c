...
#else
void    usbx_ux_device_class_storage_control_request_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_device_class_storage_control_request Test................ ");
    stepinfo("\n");
...
static void  _test_init_cbw_test_unit_ready(void)
{
...
UX_SLAVE_ENDPOINT                           *slave_endpoint;
    ...
    class_ext = class -> ux_host_class_ext;
    ...
    _ux_utility_thread_suspend(&class_ext->ux_host_class_thread);

    /* Check if test functions works.  */
    _test_init_cbw_test_unit_ready();
    ...
    /* Send transfer request - request not supported. */
    transfer_request -> ux_transfer_request_data_pointer =      UX_NULL;
    transfer_request -> ux_transfer_request_requested_length =  0;
    transfer_request -> ux_transfer_request_function =          0x1;
    ...
    /* Swap slave endpoint instance for coverage.  */
    ...
    slave_interface = slave_storage->ux_slave_class_storage_interface;

    slave_endpoint = slave_interface->ux_slave_interface_first_endpoint;
    slave_interface->ux_slave_interface_first_endpoint = slave_endpoint->ux_slave_endpoint_next_endpoint;
    slave_interface->ux_slave_interface_first_endpoint->ux_slave_endpoint_next_endpoint = slave_endpoint;
