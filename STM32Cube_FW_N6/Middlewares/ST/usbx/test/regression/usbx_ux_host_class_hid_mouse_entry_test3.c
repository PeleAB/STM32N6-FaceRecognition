...
/** How: Register the mouse class but make the USAGE_PAGE not GENERIC_DESKTOP_CONTROLS. */
/**************************************************/
...
/* We use a non-mouse report descriptor. */
static UCHAR hid_mouse_report[] = {

    /* Make the usage page not GENERIC DESKTOP CONTROLS */
...
#else
void    usbx_ux_host_class_hid_mouse_entry_test3_application_define(void *first_unused_memory)
#endif
{
...
CHAR *  memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_mouse_entry Test 3........................ ");
