...
#else
void    usbx_ux_host_class_storage_driver_entry_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_storage_driver_entry Test..................... ");
    stepinfo("\n");
...
FX_MEDIA                                    *media;
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_driver_entry - FX_DRIVER_INIT SUCCESS\n");
    ...
    status = media->fx_media_driver_status;
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_driver_entry - FX_DRIVER_WRITE ERROR\n");
    ram_disk_write_status = UX_ERROR;
    ram_disk_write_media_status = 0x003A02;
    ...
    ram_disk_write_status = 0;

    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_driver_entry - FX_DRIVER_BOOT_WRITE ERROR\n");
    ram_disk_write_status = UX_ERROR;
    ram_disk_write_media_status = 0x003A02;
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_driver_entry - FX_DRIVER_BOOT_WRITE SUCCESS\n");
    media->fx_media_driver_request = FX_DRIVER_BOOT_WRITE;
    media->fx_media_driver_buffer = buffer;
    _ux_host_class_storage_driver_entry(media);
    status = media->fx_media_driver_status;
