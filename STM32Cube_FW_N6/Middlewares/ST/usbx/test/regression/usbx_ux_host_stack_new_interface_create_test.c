...
#else
void    usbx_ux_host_stack_new_interface_create_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR                            *memory_pointer;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_new_interface_create Test..................... ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_new_interface_create Test..................... ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_new_interface_create Test..................... ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_new_interface_create Test..................... ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_new_interface_create Test..................... ERROR #6\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_new_interface_create Test..................... ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_new_interface_create Test..................... ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_new_interface_create Test..................... ERROR #8\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_new_interface_create Test..................... ERROR #9\n");
        test_control_return(1);
    }
}
...
UX_DEVICE       *device;
    ...
    /* Inform user.  */
    printf("Running ux_host_stack_new_interface_create Test..................... ");
    ...
    /* Simulate interface descriptor corruption. */

    /* Header Functional Descriptor corrupted. */

    /* Disconnect. */
    ux_test_hcd_sim_host_disconnect();

    /* Modify descriptor and expect error (descriptor length too small). */
    device_framework_full_speed[44] = 0; /* bLength: 5 -> 0 */
    ...
    if (!test_error_counter)
    {
        ...
        printf("ERROR #%d: expect error but not happen\n", __LINE__);
        error_counter ++;
    }
    device_framework_full_speed[44] = 5;

    /* Disconnect. */
    ux_test_hcd_sim_host_disconnect();

    /* Modify descriptor and expect error (last descriptor length too large). */
    device_framework_full_speed[86] = 9; /* bLength: 7 -> 9 */
    test_error_cases = UX_TRUE;
    test_error_counter = 0;
    /* Connect. */
    ux_test_hcd_sim_host_connect(UX_FULL_SPEED_DEVICE);
    ...
    device_framework_full_speed[86] = 7;

    /* Disconnect. */
    ux_test_hcd_sim_host_disconnect();

    /* Modify descriptor and expect error. */
    device_framework_full_speed[64] = 0; /* bType: 5 -> 0 */
    test_error_cases = UX_TRUE;
    test_error_counter = 0;
    /* Connect. */
    ux_test_hcd_sim_host_connect(UX_FULL_SPEED_DEVICE);
    ...
    device_framework_full_speed[64] = 5;
