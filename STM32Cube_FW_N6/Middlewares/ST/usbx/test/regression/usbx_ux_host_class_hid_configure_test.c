...
static UCHAR error_callback_expected = UX_FALSE;
...
#else
void    usbx_ux_host_class_hid_configure_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_configure test............................ ");
...
ULONG             tmp;
    ...
    /**************************************************/
    /**************************************************/
    /** Why direct: Under normal circumstances, the device is already configured by the time this is called, so it exits at the beginning. **/
    /**************************************************/
    /**************************************************/

    /**************************************************/
    /** Test case: Successful and complete execution. **/
    /** Why direct: See the function-level NOTE. **/
    /**************************************************/

    /* Make sure we succeed. */
    tmp = hid -> ux_host_class_hid_device -> ux_device_state;
    hid -> ux_host_class_hid_device -> ux_device_state = ~UX_DEVICE_CONFIGURED;
    ...
    hid -> ux_host_class_hid_device -> ux_device_state = tmp;

    /**************************************************/
    /** Test case: Bus power but no parent. **/
    /** Why direct: See the function-level NOTE. **/
    /**************************************************/

    /* Set up power source. */
    hid -> ux_host_class_hid_device -> ux_device_power_source = UX_DEVICE_BUS_POWERED;
...
#if UX_MAX_DEVICES > 1
    /**************************************************/
    /** Test case: Bus power and parent power source OK. **/
    /** Why direct: See the function-level NOTE. **/
    /**************************************************/

    /* Set up parent. */
    hid -> ux_host_class_hid_device -> ux_device_parent = &parent;
    ...
    /**************************************************/
    /** Test case: Bus power and parent power source NK. **/
    /** Why direct: See the function-level NOTE. **/
    /**************************************************/
    ...
    error_callback_expected = UX_TRUE;
...
#endif
    error_callback_expected = UX_FALSE;
