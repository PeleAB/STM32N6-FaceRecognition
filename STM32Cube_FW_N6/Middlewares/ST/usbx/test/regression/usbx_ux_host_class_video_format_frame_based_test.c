...
static unsigned char device_framework_full_speed[] = {
    ...
    */
    ...
    0x09, 0x02,
    0x57, 0x01,        /* wTotalLength 9+8+108+92+23+87+16=343  */
    0x02, 0x01, 0x00,
    0x40, 0x00,
    ...
    /* VideoStreaming Interface 2.0 @ 233+7=240; 9+78=87  */
    0x09, 0x04,
    0x02, 0x00,
    0x00,
    0x0E, 0x02, 0x00,
    0x00,
        ...
        14, 0x24, 0x01,
        0x01, /* bNumFormats  */
        78, 0x00, /* wTotalLength 14+28+30+6=78(0x4E)  */
        ...
        /* VS_FORMAT_FRAME_BASED @ 156+0xE=170 */
        28, 0x24, 0x10,
        0x01, /* bFormatIndex  */
        0x01, /* bNumFrameDescriptors  */
        'H','2','6','4',
        ...
        0x10,0x00,
        0x80,0x00,
        0x00,0xAA,0x00,0x38,0x9B,0x71,/* guidFormat */
        16,   /* bBitsPerPixel  */
        0x01, /* bDefaultFrameIndex  */
        0x00, 0x00, /* bAspectRatioX, bAspectRatioY  */
        0x02, /* bmInterlaceFlags  */
        0x00, /* bCopyProtect  */
        0x00, /* bVariableSize  */
...
#else
void    usbx_host_class_video_format_frame_based_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                  memory_pointer;
    ...
    printf("Running ux_host_class_video VS_FORMAT_FRAME_BASED Test.............. ");
...
UX_HOST_CLASS_VIDEO_PARAMETER_FRAME_DATA            frame_data;
    ...
    if (host_video_2->ux_host_class_video_length_formats != 78)
    {
    ...
    UX_TEST_ASSERT(status == UX_SUCCESS);
    UX_TEST_ASSERT(format_data.ux_host_class_video_parameter_format_subtype == UX_HOST_CLASS_VIDEO_VS_FORMAT_FRAME_BASED);
    UX_TEST_ASSERT(format_data.ux_host_class_video_parameter_format_guid != UX_NULL);
    UX_TEST_ASSERT(format_data.ux_host_class_video_parameter_format_guid[0] == 'H');
    UX_TEST_ASSERT(format_data.ux_host_class_video_parameter_format_guid[1] == '2');
    UX_TEST_ASSERT(format_data.ux_host_class_video_parameter_format_guid[2] == '6');
    UX_TEST_ASSERT(format_data.ux_host_class_video_parameter_format_guid[3] == '4');
    UX_TEST_ASSERT(format_data.ux_host_class_video_parameter_number_frame_descriptors == 1);
    ...
    status = _ux_host_class_video_frame_parameters_set(host_video_2,
        UX_HOST_CLASS_VIDEO_VS_FORMAT_FRAME_BASED, 160, 120, 666666);
    UX_TEST_ASSERT_MESSAGE(status == UX_SUCCESS, "ERROR #%d: set parameters fail 0x%x\n", __LINE__, status);
    _ux_utility_long_put(_probe_control_data + 22, 0);
    status = _ux_host_class_video_frame_parameters_set(host_video_2,
        UX_HOST_CLASS_VIDEO_VS_FORMAT_FRAME_BASED, 160, 120, 666666);
