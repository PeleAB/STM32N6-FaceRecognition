...
static UX_HOST_CLASS_STORAGE           *host_storage = UX_NULL;
...
static unsigned char device_framework_full_speed[] = {
    ...
    */
    ...
    _INTERFACE_DESCRIPTOR(0, 0, 1, 0x08, 0x06, 0x50)
...
UX_HOST_CLASS_STORAGE *storage_inst = (UX_HOST_CLASS_STORAGE *) inst;
    ...
    case UX_DEVICE_INSERTION:
        ...
        host_storage = storage_inst;
        break;

    case UX_DEVICE_REMOVAL:
        host_device_removal_counter ++;
        if (host_storage == storage_inst)
...
#else
void    usbx_msrc_81142_host_storage_endpoints_get_tests_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                  memory_pointer;
    ...
    printf("Running MSRC 81112 - Host Storage EPs Get Test...................... ");
...
{
    if (device_dummy == UX_NULL && host_storage == UX_NULL)
        return(UX_SUCCESS);
    return(UX_ERROR);
}
