...
#else
void    usbx_ux_device_class_hid_uninitialize_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_device_class_hid_uninitialize Test....................... ");
...
UX_SLAVE_CLASS_COMMAND          command;
    ...
    /**************************************************/
    /** Test case: if (hid != UX_NULL) fails **/
    /** Why direct: This function is only called if the HID class was registered. When it's registered, hid_initialize() is called, which sets 'class -> ux_slave_class_instance'. **/
    /**************************************************/
    ...
    if (_ux_device_class_hid_uninitialize(&command) != UX_SUCCESS)
    {
