...
static UINT     num_get_config_descs;
    ...
    case UX_HCD_TRANSFER_REQUEST:
        ...
        /* Is this a GetConfigDescriptor request for the entire descriptor? */
            ...
            transfer_request -> ux_transfer_request_index == 0)
        {
            ...
            /* We want the second one, which happens in _descriptor_parse(). */
            num_get_config_descs++;
            if (num_get_config_descs == 2)
            {
...
#else
void    usbx_ux_host_class_hid_descriptor_parse_test4_application_define(void *first_unused_memory)
#endif
{
...
ALIGN_TYPE                      tmp;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_descriptor_parse Test 4................... ");
    ...
    /**************************************************/
    /** Test case: transfer_request -> ux_transfer_request_actual_length == configuration_descriptor.wTotalLength fails in **/
