...
#else
void    usbx_ux_host_stack_class_get_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_HID_PARAMETER    hid_parameter;
    ...
    /* Inform user.  */
    printf("Running ux_host_stack_class_get Test................................ ");
    stepinfo("\n");
...
UX_HOST_CLASS                   *host_class;
    ...
    stepinfo(">>>>>>>>> _ux_host_stack_class_get - error if class_name exceed UX_MAX_CLASS_NAME_LENGTH\n");
    ...
    status =  _ux_host_stack_class_get(invalid_class_name, &host_class);
    if (status != UX_ERROR)
    {
