...
#else
void    usbx_ux_host_class_hid_client_register_test2_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_client_register Test2..................... ");
...
UCHAR                           invalid_name[UX_HOST_CLASS_HID_MAX_CLIENT_NAME_LENGTH+2];
    ...
    /**************************************************/
    /** Test case: corrupt hid_client_name           **/
    /**************************************************/
    _ux_utility_memory_set(invalid_name, ' ', sizeof(invalid_name));
    _ux_utility_memory_copy(invalid_name, _ux_system_host_class_hid_client_keyboard_name, 33);
    status = _ux_host_class_hid_client_register(invalid_name, ux_host_class_hid_keyboard_entry);
    if (status != UX_ERROR)
    {
    ...
    /**************************************************/
    /** Test case: class -> ux_host_class_client =  _ux_utility_memory_allocate(UX_NO_ALIGN, UX_REGULAR_MEMORY,
                    sizeof(UX_HOST_CLASS_HID_CLIENT)*UX_HOST_CLASS_HID_MAX_CLIENTS); fails **/
    /**************************************************/
    ...
    status = _ux_host_class_hid_client_register(_ux_system_host_class_hid_client_keyboard_name, ux_host_class_hid_keyboard_entry);
    ...
    _ux_system -> ux_system_memory_byte_pool[UX_MEMORY_BYTE_POOL_REGULAR] -> ux_byte_pool_start = (UCHAR*)original_memory_block;
