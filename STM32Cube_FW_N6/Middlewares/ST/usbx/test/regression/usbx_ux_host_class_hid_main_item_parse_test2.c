...
/** How: Two application collections, the first one having a zero usage page, and a non-zero usage. **/
/** Note: Since USBX doesn't support any devices with a usage page of 0, it generates an error and will call our error callback. **/
/**************************************************/
...
static UCHAR hid_report_descriptor[] = {
    ...
    /* Make sure the usage page is 0 */
    0x05, 0x00,                    // USAGE_PAGE ()
    /* Make sure the usage is not 0 */
...
#else
void    usbx_ux_host_class_hid_main_item_parse_test2_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_main_item_parse Test 2.................... ");
