...
static UCHAR hid_report_descriptor[] = {
    ...
    /* Set the tag to an unknown value (examples of tags are INPUT, OUTPUT, and FEATURE) */
    0x71, 0x00,                    //   ???
    0xc0                           // END_COLLECTION
};
...
#else
void    usbx_ux_host_class_hid_main_item_parse_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_main_item_parse Test...................... ");
