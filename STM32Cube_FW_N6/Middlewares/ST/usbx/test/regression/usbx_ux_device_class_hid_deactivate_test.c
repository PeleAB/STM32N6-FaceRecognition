...
static UINT was_instance_deactivate_callback_called;
...
static VOID instance_deactivate_callback(VOID *parameter)
{
    ...
    was_instance_deactivate_callback_called = 1;
}
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_device_class_hid_deactivate test ........................ ");
...
UINT status;
    ...
    if (was_instance_deactivate_callback_called != 1) {
