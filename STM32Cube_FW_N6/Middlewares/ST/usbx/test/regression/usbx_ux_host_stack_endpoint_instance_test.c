...
#else
void    usbx_ux_host_stack_endpoint_instance_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_DPUMP_PARAMETER  parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_... Test.................... ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_... Test.................... ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_... Test.................... ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_... Test.................... ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_... Test.................... ERROR #6\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_... Test.................... ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_... Test.................... ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_... Test.................... ERROR #8\n");
        test_control_return(1);
    }
}
...
static void  ux_test_thread_simulation_0_entry(ULONG arg)
{
    ...
    /* Inform user.  */
    printf("Running ux_host_stack_endpoint_instance_... Test.................... ");
