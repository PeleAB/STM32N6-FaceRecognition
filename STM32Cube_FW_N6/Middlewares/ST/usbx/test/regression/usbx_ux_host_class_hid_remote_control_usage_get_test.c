...
#else
void    usbx_ux_host_class_hid_remote_control_usage_get_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_remote_control_usage_get_test Test........ ");
...
UX_HOST_CLASS_HID_REMOTE_CONTROL    fake_remote_control;
ULONG                               usage;
ULONG                               value;
    ...
    /* Make sure _ux_host_stack_class_instance_verify() doesn't our class. */
    fake_remote_control.ux_host_class_hid_remote_control_hid = &fake_hid;

    status = _ux_host_class_hid_remote_control_usage_get(&fake_remote_control, &usage, &value);
