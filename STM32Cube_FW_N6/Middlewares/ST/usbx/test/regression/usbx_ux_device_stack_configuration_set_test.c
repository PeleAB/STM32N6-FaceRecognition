...
UX_SLAVE_CLASS_HID_PARAMETER    hid_parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_configuration_set Test...................... ERROR #6\n");
        test_control_return(1);
    }
#endif
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_configuration_set Test...................... ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_configuration_set Test...................... ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_configuration_set Test...................... ERROR #8\n");
        test_control_return(1);
    }
}
...
UX_SLAVE_DEVICE         *device;
    ...
    /* Inform user.  */
    printf("Running ux_device_stack_configuration_set Test...................... ");
