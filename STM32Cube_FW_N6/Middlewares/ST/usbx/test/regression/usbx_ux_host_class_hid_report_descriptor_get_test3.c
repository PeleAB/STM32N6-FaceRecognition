...
UX_TRANSFER    *transfer_request;
    ...
    case UX_HCD_TRANSFER_REQUEST:
        ...
        /* Is this the transfer request from descriptor_get()? */
        if (transfer_request -> ux_transfer_request_function == UX_GET_DESCRIPTOR &&
...
#else
void    usbx_ux_host_class_hid_report_descriptor_get_test3_application_define(void *first_unused_memory)
#endif
{
...
ALIGN_TYPE                      tmp;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_report_descriptor_get Test 3....................... ");
    ...
    /**************************************************/
    /** Test case: transfer_request -> ux_transfer_request_actual_length == length fails in **/
