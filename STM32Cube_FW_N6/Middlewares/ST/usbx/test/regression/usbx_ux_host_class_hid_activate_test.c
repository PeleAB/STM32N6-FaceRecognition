...
#else
void    usbx_ux_host_class_hid_activate_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *  memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_activate Test............................. ");
...
// UX_MEMORY_BLOCK                      *original_memory_block = _ux_system -> ux_system_regular_memory_pool_start;
UX_HOST_CLASS_HID                    *hid_instance;
TX_SEMAPHORE                          hid_instance_semaphore_copy;
UX_HOST_CLASS                        *class;
    ...
    /**************************************************/
    /** Test case: _ux_utility_semaphore_create() fails **/
    /**************************************************/
    ...
    command.ux_host_class_command_container = hid -> ux_host_class_hid_interface;
    command.ux_host_class_command_class_ptr = class;

    /* Allocate a hid instance like hid_activate(). */
    hid_instance =  _ux_utility_memory_allocate(UX_NO_ALIGN,  UX_REGULAR_MEMORY,sizeof(UX_HOST_CLASS_HID));
    ...
    status =  _ux_utility_semaphore_create(&hid_instance -> ux_host_class_hid_semaphore, "ux_host_class_hid_semaphore", 1);
    if (status != UX_SUCCESS)
    {
    ...
    hid_instance_semaphore_copy = hid_instance -> ux_host_class_hid_semaphore;
    ...
    /* ux_utility_memory_allocate() zero'd out our hid instance semaphore! Good thing we made a copy! */
    hid_instance -> ux_host_class_hid_semaphore = hid_instance_semaphore_copy;
...
#if 0 /* Tested by basic_memory_test */
    /**************************************************/
    /** Test case: hid =  _ux_utility_memory_allocate(UX_NO_ALIGN,  UX_REGULAR_MEMORY,sizeof(UX_HOST_CLASS_HID)) fails. **/
    /**************************************************/
