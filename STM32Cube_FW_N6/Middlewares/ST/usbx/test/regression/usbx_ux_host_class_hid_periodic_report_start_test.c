...
#else
void    usbx_ux_host_class_hid_periodic_report_start_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_periodic_report_start Test................ ");
...
ULONG       tmp;
    ...
    status = _ux_host_class_hid_periodic_report_start(UX_NULL);
    ...
    /**************************************************/
    /** Test case: if (hid -> ux_host_class_hid_interrupt_endpoint_status != UX_HOST_CLASS_HID_INTERRUPT_ENDPOINT_READY) **/
    /** Why direct: this will always fail if there is an interrupt endpoint. if there is none, it's a user error. **/
    /**************************************************/

    /* Set endpoint to non-ready state. */
    tmp = hid -> ux_host_class_hid_interrupt_endpoint_status;
    ...
    hid -> ux_host_class_hid_interrupt_endpoint_status = tmp;
