...
#else
void    usbx_ux_host_stack_interfaces_scan_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_DPUMP_PARAMETER  parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interfaces_scan Test.......................... ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interfaces_scan Test.......................... ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interfaces_scan Test.......................... ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interfaces_scan Test.......................... ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interfaces_scan Test.......................... ERROR #6\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interfaces_scan Test.......................... ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interfaces_scan Test.......................... ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interfaces_scan Test.......................... ERROR #8\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interfaces_scan Test.......................... ERROR #9\n");
        test_control_return(1);
    }
}
...
UX_DEVICE       *device;
    ...
    /* Inform user.  */
    printf("Running ux_host_stack_interfaces_scan Test.......................... ");
    ...
    /* Simulate _ux_host_stack_interfaces_scan error cases. */
    ...
    /* Modify descriptor to generate errors. */
    device_framework_full_speed[18] = 0; /* bLength: 9 -> 0 */
    ...
    if (!test_error_counter)
    {
        ...
        printf("ERROR #%d: expect configuration descriptor corrupt error\n", __LINE__);
        error_counter ++;
    }
    /* Restore descriptor. */
    device_framework_full_speed[18] = 9;

    /* Disconnect. */
    ux_test_hcd_sim_host_disconnect();

    /* Modify descriptor to generate errors. */
    device_framework_full_speed[18] = 99; /* bLength: 9 -> 99 */
