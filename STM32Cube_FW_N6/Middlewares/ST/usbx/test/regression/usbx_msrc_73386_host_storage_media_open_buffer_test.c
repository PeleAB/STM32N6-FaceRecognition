...
#define                             UX_RAM_DISK_SECTOR_SIZE         512
#define                             UX_RAM_DISK_SIZE                (200 * 1024)
#define                             UX_RAM_DISK_N_LB                (UX_RAM_DISK_SIZE / UX_RAM_DISK_SECTOR_SIZE)
#define                             UX_RAM_DISK_LAST_LBA            (UX_RAM_DISK_N_LB - 1)

#define                             UX_STORAGE_SECTOR_SIZE          4096
...
static CHAR                         ram_disk_buffer1[UX_STORAGE_SECTOR_SIZE];
static CHAR                         ram_disk_buffer2[UX_STORAGE_SECTOR_SIZE];
...
static UINT                                error_callback_last_code = UX_SUCCESS;
...
static VOID error_callback(UINT system_level, UINT system_context, UINT error_code)
{
    ...
    error_callback_last_code = error_code;
...
#else
void    usbx_msrc_73386_host_storage_media_open_buffer_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running MSRC 73386 Host Storage Media Open Test..................... ");
    stepinfo("\n");
    ...
    fx_media_format(&ram_disk_media1, _fx_ram_driver, ram_disk_memory1, ram_disk_buffer1, sizeof(ram_disk_buffer1), "RAM DISK1", 2, 512, 0, UX_RAM_DISK_N_LB, UX_RAM_DISK_SECTOR_SIZE, 4, 1, 1);
    fx_media_format(&ram_disk_media2, _fx_ram_driver, ram_disk_memory2, ram_disk_buffer2, sizeof(ram_disk_buffer2), "RAM DISK2", 2, 512, 0, UX_RAM_DISK_N_LB, UX_RAM_DISK_SECTOR_SIZE, 4, 1, 1);
    ...
    global_storage_parameter.ux_slave_class_storage_parameter_lun[0].ux_slave_class_storage_media_block_length    =  UX_STORAGE_SECTOR_SIZE;
    ...
    global_storage_parameter.ux_slave_class_storage_parameter_lun[1].ux_slave_class_storage_media_block_length    =  UX_STORAGE_SECTOR_SIZE;
...
FX_MEDIA                                    *media;
    ...
    /* Media mount should fail.  */
    UX_TEST_CHECK_NOT_SUCCESS(status);
    /* Last error: memory error.  */
    UX_TEST_CHECK_CODE(UX_HOST_CLASS_MEMORY_ERROR, error_callback_last_code);
...
static UINT    demo_thread_media_read(VOID *storage, ULONG lun, UCHAR * data_pointer, ULONG number_blocks, ULONG lba, ULONG *media_status)
{
    ...
    ux_utility_memory_copy(data_pointer, &ram_disk_memory[lun][lba * UX_STORAGE_SECTOR_SIZE], number_blocks * UX_STORAGE_SECTOR_SIZE);
...
static UINT    demo_thread_media_write(VOID *storage, ULONG lun, UCHAR * data_pointer, ULONG number_blocks, ULONG lba, ULONG *media_status)
{
    ...
    ux_utility_memory_copy(&ram_disk_memory[lun][lba * UX_STORAGE_SECTOR_SIZE], data_pointer, number_blocks * UX_STORAGE_SECTOR_SIZE);
