...
#else
void    usbx_hid_report_descriptor_delimiter_test_application_define(void *first_unused_memory)
#endif
{
...
UINT        descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Delimiter Test....................... ");
...
UX_HOST_CLASS_HID_FIELD             *report_field;
    ...
    if(
       report_field -> ux_host_class_hid_field_logical_min != 0 ||
       report_field -> ux_host_class_hid_field_logical_max != 3 ||
       report_field -> ux_host_class_hid_field_physical_min != 0 ||
       report_field -> ux_host_class_hid_field_physical_max != 270 ||
       report_field -> ux_host_class_hid_field_unit != 0x14 ||
       report_field -> ux_host_class_hid_field_unit_expo != 0 ||
       report_field -> ux_host_class_hid_field_report_id != 0 ||
