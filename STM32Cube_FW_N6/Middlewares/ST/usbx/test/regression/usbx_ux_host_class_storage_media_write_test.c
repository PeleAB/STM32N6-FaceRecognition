...
#else
void    usbx_ux_host_class_storage_media_write_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_storage_media_write Test...................... ");
    stepinfo("\n");
...
UX_INTERFACE                                *interface;
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_media_write - SENSE ERROR\n");
    ram_disk_write_status = UX_ERROR;
    ram_disk_write_media_status = 0x003A02;
    status = _ux_host_class_storage_media_write(storage, 0, 1, buffer);
