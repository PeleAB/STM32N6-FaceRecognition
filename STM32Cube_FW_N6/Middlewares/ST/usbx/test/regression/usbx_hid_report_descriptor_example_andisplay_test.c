...
#else
void    usbx_hid_report_descriptor_example_andisplay_test_application_define(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Example andisplay Test................ ");
