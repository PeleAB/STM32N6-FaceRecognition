...
#else
void    usbx_ux_host_class_storage_media_capacity_get_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_storage_media_capacity_get Test............... ");
    stepinfo("\n");
...
UX_DEVICE                                   *device;
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_media_capacity_get - UX_HOST_CLASS_STORAGE_MEDIA_CDROM\n");
    storage -> ux_host_class_storage_media_type = UX_HOST_CLASS_STORAGE_MEDIA_CDROM;
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_media_capacity_get - Unsupported\n");
    storage -> ux_host_class_storage_media_type = 0xFF;
    status = _ux_host_class_storage_media_capacity_get(storage);
