...
static UCHAR product_serial[40];
static void line190_coverage(void)
{
    ...
    slave_storage.ux_slave_class_storage_product_serial = product_serial;
    _ux_device_class_storage_inquiry(&slave_storage, 0, &endpoint_in, NX_NULL, cbwcb_data);
...
#else
void    usbx_ux_device_class_storage_inquiry_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_device_class_storage_inquiry Test........................ ");
    stepinfo("\n");
...
UX_SLAVE_CLASS_STORAGE                      *slave_storage;
    ...
    UX_TEST_ASSERT(storage -> ux_host_class_storage_data_phase_length < 64);
    UX_TEST_ASSERT(_ux_utility_long_get(storage -> ux_host_class_storage_csw + UX_SLAVE_CLASS_STORAGE_CSW_DATA_RESIDUE) == 64 - storage -> ux_host_class_storage_data_phase_length);
