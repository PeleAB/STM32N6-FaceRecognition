...
CHAR *                  memory_pointer;
    ...
    /* Inform user.  */
    printf("Running Audio 1.0 IAD Device Basic Functionality Test............... ");
    stepinfo("\n");
    ...
    temp = (slave_audio_stream_parameter[0].ux_device_class_audio_stream_parameter_max_frame_buffer_size+8) *
            slave_audio_stream_parameter[0].ux_device_class_audio_stream_parameter_max_frame_buffer_nb;
    printf(" per _frame_buffer_size: (%ld + 8) * %ld = %ld\n",
        slave_audio_stream_parameter[0].ux_device_class_audio_stream_parameter_max_frame_buffer_size,
        slave_audio_stream_parameter[0].ux_device_class_audio_stream_parameter_max_frame_buffer_nb,
        temp);
    ...
    printf(" per _audio: _AUDIO + _stream * 2 + _CONTROL * 0 = %ld\n", temp);
#endif
