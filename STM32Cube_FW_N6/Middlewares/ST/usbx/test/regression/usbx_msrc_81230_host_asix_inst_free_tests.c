...
static UX_HOST_CLASS_ASIX           *host_asix = UX_NULL;
...
#define _CFG_TOTAL_LEN (9+9+7+7+7+7)
...
static unsigned char device_framework_full_speed[] = {
    ...
    */
    /* REF:
       12 01 10 02 00 00 00 40 95 0B 90 17 00 02 01 02 03 03  */
    0x12, 0x01, 0x10, 0x02,
    0x00, 0x00, 0x00,
    0x40,
    0x95, 0x0B,
...
UX_HOST_CLASS_ASIX *asix_inst = (UX_HOST_CLASS_ASIX *) inst;
...
UCHAR *cmd_buf = transfer_request -> ux_slave_transfer_request_data_pointer;
    ...
    if (device_dummy == dummy_instance)
    {
        ...
        switch(cmd_type)
        {
        case 0x19c0: /* READ_PHY_ID: return 2 bytes  */
            ...
            cmd_buf[0] = 0x01;
            cmd_buf[1] = 0x00;
            ux_device_stack_transfer_request(transfer_request, 2, 2);
            break;

        case 0x1f40: /* WRITE_GPIO_STATUS: */
            break;

        case 0x2240: /* WRITE_SW_PHY_SELECT_STATUS: */
            break;

        case 0x2040: /* SW_RESET:  */
            break;

        case 0x1040: /* WRITE_RX_CTL: */
            break;

        case 0x13c0: /* READ_NODE_ID: return 6 bytes  */
            cmd_buf[0] = 0x01;
            cmd_buf[1] = 0x02;
            cmd_buf[2] = 0x03;
            cmd_buf[3] = 0x04;
            cmd_buf[4] = 0x05;
            cmd_buf[5] = 0x06;
            ux_device_stack_transfer_request(transfer_request, 6, 6);
            break;

        case 0x0640: /* OWN_SMI:  */
            break;

        case 0x07c0: /* READ_PHY_REG: return 2 bytes  */
            cmd_buf[0] = 0x01;
            cmd_buf[1] = 0x00;
            ux_device_stack_transfer_request(transfer_request, 2, 2);
            break;

        case 0x0840: /* WRITE_PHY_REG:  */
            break;

        case 0x1b40: /* WRITE_MEDIUM_MODE:  */
            break;

        case 0x1240: /* WRITE_IPG012:  */
            break;

        case 0x0a40: /* RELEASE_SMI:  */
            break;
...
#else
void    usbx_msrc_81230_host_asix_inst_free_tests_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                  memory_pointer;
    ...
    printf("Running MSRC 81230 - Host ASIX inst free Test....................... ");
    ...
    status =  ux_host_stack_class_register(_ux_system_host_class_asix_name, _ux_host_class_asix_entry);
...
{
    if (device_dummy == UX_NULL && host_asix == UX_NULL)
        return(UX_SUCCESS);
    return(UX_ERROR);
}
