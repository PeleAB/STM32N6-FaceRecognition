...
static UX_DEVICE_CLASS_PRINTER_PARAMS       device_printer_parameter;
...
CHAR *                  memory_pointer;
    ...
    device_printer_parameter.device_id = printer_device_id;
    device_printer_parameter.device_id_length = sizeof(printer_device_id);
    device_printer_parameter.instance_activate   = test_printer_instance_activate;
    device_printer_parameter.instance_deactivate = test_printer_instance_deactivate;
