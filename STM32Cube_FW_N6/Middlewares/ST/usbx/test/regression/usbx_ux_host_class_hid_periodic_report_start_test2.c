...
static VOID error_callback(UINT system_level, UINT system_context, UINT error_code)
{
    ...
    if (error_code != UX_TRANSFER_ERROR)
    {
...
#else
void    usbx_ux_host_class_hid_periodic_report_start_test2_application_define(void *first_unused_memory)
#endif
{
...
ALIGN_TYPE                      tmp;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_periodic_report_start Test 2.............. ");
    ...
    /**************************************************/
    /** Test case: ux_host_stack_transfer_request(transfer_request) fails. **/
    /**************************************************/
...
UINT    status;
    ...
    /* Wait for test case to execute in enum thread. */
    tx_thread_sleep(100);
