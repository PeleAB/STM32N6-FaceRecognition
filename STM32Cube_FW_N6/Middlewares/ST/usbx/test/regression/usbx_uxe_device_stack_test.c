...
UCHAR                                  *buffer = (UCHAR *)&status;
    ...
    status =  ux_device_stack_initialize(UX_NULL, 64, buffer, 64, buffer, 64, buffer, 64, UX_NULL);
    UX_TEST_CHECK_CODE(UX_INVALID_PARAMETER, status);
    status =  ux_device_stack_initialize(buffer, 64, UX_NULL, 64, buffer, 64, buffer, 64, UX_NULL);
    UX_TEST_CHECK_CODE(UX_INVALID_PARAMETER, status);
    status =  ux_device_stack_initialize(buffer, 64, buffer, 0, buffer, 64, buffer, 64, UX_NULL);
    UX_TEST_CHECK_CODE(UX_INVALID_PARAMETER, status);
    status =  ux_device_stack_initialize(buffer, 64, buffer, 64, UX_NULL, 64, buffer, 64, UX_NULL);
    UX_TEST_CHECK_CODE(UX_INVALID_PARAMETER, status);
    status =  ux_device_stack_initialize(buffer, 64, buffer, 64, buffer, 64, UX_NULL, 64, UX_NULL);
    UX_TEST_CHECK_CODE(UX_INVALID_PARAMETER, status);
    status =  ux_device_stack_initialize(buffer, 64, buffer, 64, buffer, 64, buffer, 0, UX_NULL);
    UX_TEST_CHECK_CODE(UX_INVALID_PARAMETER, status);

    /* ux_device_stack_class_register()  */
    status =  ux_device_stack_class_register(UX_NULL, _ux_device_class_dummy_entry, 0, 1, UX_NULL);
    UX_TEST_CHECK_CODE(UX_INVALID_PARAMETER, status);
    status =  ux_device_stack_class_register(_ux_device_class_dummy_name, UX_NULL, 0, 1, UX_NULL);
    UX_TEST_CHECK_CODE(UX_INVALID_PARAMETER, status);

    /* ux_device_stack_class_unregister()  */
    status =  ux_device_stack_class_unregister(UX_NULL, _ux_device_class_dummy_entry);
    UX_TEST_CHECK_CODE(UX_INVALID_PARAMETER, status);
    status =  ux_device_stack_class_unregister(_ux_device_class_dummy_name, UX_NULL);
    UX_TEST_CHECK_CODE(UX_INVALID_PARAMETER, status);
