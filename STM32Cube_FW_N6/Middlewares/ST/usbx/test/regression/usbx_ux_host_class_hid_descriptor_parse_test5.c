...
static UCHAR dummy_configuration_descriptor[] = {
    ...
    /* HID descriptor */
        0x09,
        0x20, /* HID descriptors have a 0x21 here. Change it to something RADically different. */
        0x10, 0x01, 0x21, 0x01, 0x22, LSB(HID_REPORT_LENGTH),
        MSB(HID_REPORT_LENGTH),
...
#else
void    usbx_ux_host_class_hid_descriptor_parse_test5_application_define(void *first_unused_memory)
#endif
{
...
ALIGN_TYPE                      tmp;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_descriptor_parse Test 5................... ");
    ...
    /**************************************************/
    /** Test case: while (total_configuration_length) fails **/
    /**************************************************/
