...
#else
void    usbx_ux_host_stack_class_instance_destroy_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_DPUMP_PARAMETER  parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_instance_destroy Test................... ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_instance_destroy Test................... ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_instance_destroy Test................... ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_instance_destroy Test................... ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_instance_destroy Test................... ERROR #6\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_instance_destroy Test................... ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_instance_destroy Test................... ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_instance_destroy Test................... ERROR #8\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_instance_destroy Test................... ERROR #9\n");
        test_control_return(1);
    }
}
...
UX_HOST_CLASS   *class;
UX_DEVICE       *device;
UX_HOST_CLASS   class_backup;

    /* Inform user.  */
    printf("Running ux_host_stack_class_instance_destroy Test................... ");
    ...
    /* Simulate _ux_host_stack_class_instance_destroy error cases. */

    /* Backup class */
    ux_utility_memory_copy(&class_backup, class, sizeof(UX_HOST_CLASS));

    /* We are testing error cases. */
    test_error_cases = UX_TRUE;

    /* Simulate error: no class instance attached. */
    class->ux_host_class_first_instance = UX_NULL;
    status = _ux_host_stack_class_instance_destroy(class, class_backup.ux_host_class_first_instance);
    if (status == UX_SUCCESS)
    {

        printf("ERROR #%d: Expects fail since no class instance in class\n", __LINE__);
        error_counter ++;
    }

    /* Restore class */
    ux_utility_memory_copy(class, &class_backup, sizeof(UX_HOST_CLASS));

    /* Simulate error: class instance not found. */
    status = _ux_host_stack_class_instance_destroy(class, &actual_length);
    if (status == UX_SUCCESS)
    {

        printf("ERROR #%d: Expects fail since no class instance match\n", __LINE__);
        error_counter ++;
    }

    /* We finish testing error cases. */
