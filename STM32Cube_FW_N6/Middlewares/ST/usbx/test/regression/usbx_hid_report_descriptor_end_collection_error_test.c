...
#else
void    usbx_hid_report_descriptor_end_collection_error_test_application_define(void *first_unused_memory)
#endif
{
...
UINT    descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor End Collection Error Test............. ");
