...
#else
void    usbx_ux_host_class_storage_request_sense_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_storage_request_sense Test.................... ");
    stepinfo("\n");
...
UX_DEVICE                                   *device;
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_request_sense - UX_SUCCESS\n");
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_request_sense - UX_MEMORY_INSUFFICIENT\n");
