...
/* DPUMP interface descriptors 9+7+7+7+7=37 bytes. */
#define DPUMP_IFC_DESC_ALL(ifc, bulk_in_epa, bulk_out_epa, int_in_epa, int_out_epa) \
    /* Interface descriptor */\
    0x09, 0x04, (ifc), 0x00, 0x04, 0x99, 0x99, 0x99, 0x00,\
    ...
    0x07, 0x05, (int_out_epa), 0x02, 0x40, 0x00, 0x00,\
    /* Endpoint descriptor (Interrupt In) */\
    0x07, 0x05, (int_in_epa), 0x02, 0x40, 0x00, 0x00,
#define DPUMP_IFC_DESC_ALL_LEN 37
...
static UCHAR device_framework_full_speed[] = {
    ...
    /* DPUMP 9+7+7+7+7  =37 */
    DPUMP_IFC_DESC_ALL(0, 0x81, 0x02, 0x83, 0x04)
    /* HID   9+9 + 9+9+7=43 */
    HID_MOUSE_IFC0_DESC_ALL(1)
    HID_MOUSE_IFC1_DESC_ALL(1, 0x85)
};
...
#else
void    usbx_ux_device_stack_interface_set_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_HID_PARAMETER    hid_parameter;
    ...
    printf("Running ux_device_stack_interface_set Test.......................... SKIP!");
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_set Test.......................... ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_set Test.......................... ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_set Test.......................... ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_set Test.......................... ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_set Test.......................... ERROR #6\n");
        test_control_return(1);
    }
#endif
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_set Test.......................... ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_set Test.......................... ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_set Test.......................... ERROR #8\n");
        test_control_return(1);
    }
}
...
ULONG                    endpoints_pool_number;
    ...
    /* Inform user.  */
    printf("Running ux_device_stack_interface_set Test.......................... ");
    ...
    /* Unconfigure. */
    status = _ux_device_stack_configuration_set(0);
    if (status != UX_SUCCESS)
    {

        printf("ERROR #%d: Unconfigure fail\n", __LINE__);
        test_control_return(1);
    }

    /* Limit endpoints pool to generate error. */
    endpoints_pool_number = device->ux_slave_device_endpoints_pool_number;
    device->ux_slave_device_endpoints_pool_number = 0;

    /* Configure. */
    status = _ux_device_stack_configuration_set(1);
    if (status != UX_SUCCESS)
    {

        printf("ERROR #%d: Configure fail code %x\n", __LINE__, status);
        test_control_return(1);
    }
    ...
    /* Endpoint creation fail on other than EP0. */
