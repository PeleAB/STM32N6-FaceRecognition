...
#else
void    usbx_ux_device_stack_control_request_process_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_HID_PARAMETER    hid_parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_control_request_process Test................ ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_control_request_process Test................ ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_control_request_process Test................ ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_control_request_process Test................ ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_control_request_process Test................ ERROR #6\n");
        test_control_return(1);
    }
#endif
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_control_request_process Test................ ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_control_request_process Test................ ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_control_request_process Test................ ERROR #8\n");
        test_control_return(1);
    }
}
...
UX_TRANSFER             *transfer_request;
    ...
    /* Inform user.  */
    printf("Running ux_device_stack_control_request_process Test................ ");
    ...
    transfer_request -> ux_transfer_request_function =          0xFF;
    transfer_request -> ux_transfer_request_type =              UX_REQUEST_OUT | UX_REQUEST_TYPE_CLASS | UX_REQUEST_TARGET_INTERFACE;
    transfer_request -> ux_transfer_request_value =             0;

    /* Issue class/vendor request, index 0 - class registered. */
    transfer_request -> ux_transfer_request_index =             0;
    status = ux_host_stack_transfer_request(transfer_request);
    if (status != UX_TRANSFER_STALLED && status != UX_SUCCESS)
    {

        printf("ERROR #%d: expect error but got %x\n", __LINE__, status);
        error_counter ++;
    }
    ...
    /* Issue class/vendor request, index 2 - class not registered. */
    transfer_request -> ux_transfer_request_type =              UX_REQUEST_OUT | UX_REQUEST_TYPE_CLASS | UX_REQUEST_TARGET_INTERFACE;
    ...
    /* Issue class/vendor request, index 20 - invalid interface. */
    transfer_request -> ux_transfer_request_type =              UX_REQUEST_OUT | UX_REQUEST_TYPE_CLASS | UX_REQUEST_TARGET_INTERFACE;
    transfer_request -> ux_transfer_request_index =            20;
    status = ux_host_stack_transfer_request(transfer_request);
    if (status != UX_TRANSFER_STALLED)
    {
    ...
    slave_endpoint = &slave_device -> ux_slave_device_control_endpoint;
    /* Endpoint transfer request. */
    slave_transfer_request = &slave_endpoint -> ux_slave_endpoint_transfer_request;

    /* Error case: ux_slave_transfer_request_completion_code error. */
    slave_transfer_request->ux_slave_transfer_request_completion_code = UX_ERROR;
    status = _ux_device_stack_control_request_process(slave_transfer_request);
    if (status == UX_SUCCESS)
    {
