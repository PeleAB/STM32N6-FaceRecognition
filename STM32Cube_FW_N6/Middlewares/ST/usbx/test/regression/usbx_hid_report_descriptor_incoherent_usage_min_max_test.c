...
static UCHAR hid_report_descriptor[] = {
    ...
    0xa1, 0x01,                    // COLLECTION (Application)
                                   ...
                                   /*   Have a larger minimum than maximum. */
    0x19, 0xff,                    //   USAGE_MINIMUM (255)
...
#else
void    usbx_hid_report_descriptor_incoherent_usage_min_max_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Incoherent Usage Min Max Test......... ");
