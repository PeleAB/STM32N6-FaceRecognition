...
#else
void    usbx_ux_device_stack_interface_start_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_HID_PARAMETER    hid_parameter;
    ...
    printf("Running ux_device_stack_interface_start Test........................ SKIP!");
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_start Test........................ ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_start Test........................ ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_start Test........................ ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_start Test........................ ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_start Test........................ ERROR #6\n");
        test_control_return(1);
    }
#endif
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_start Test........................ ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_start Test........................ ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_start Test........................ ERROR #8\n");
        test_control_return(1);
    }
}
...
UX_SLAVE_DEVICE         *device;
    ...
    /* Inform user.  */
    printf("Running ux_device_stack_interface_start Test........................ ");
