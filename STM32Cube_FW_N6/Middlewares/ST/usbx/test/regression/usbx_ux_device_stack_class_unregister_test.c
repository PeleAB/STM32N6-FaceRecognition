...
#else
void    usbx_ux_device_stack_class_unregister_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_HID_PARAMETER    hid_parameter;
    ...
    /* Inform user.  */
    printf("Running ux_device_stack_class_unregister Test....................... ");
    stepinfo("\n");
...
UCHAR                           invalid_class_name[UX_MAX_CLASS_NAME_LENGTH+2];
    ...
    stepinfo(">>>>>>>>> _ux_device_stack_class_unregister - error if class_name exceed UX_MAX_CLASS_NAME_LENGTH\n");
    ...
    status =  _ux_device_stack_class_unregister(invalid_class_name, _ux_device_class_dpump_entry);
    if (status != UX_ERROR)
    {
