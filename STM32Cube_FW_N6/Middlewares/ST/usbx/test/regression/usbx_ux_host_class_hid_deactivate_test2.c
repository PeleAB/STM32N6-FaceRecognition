...
#else
void    usbx_ux_host_class_hid_deactivate_test2_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_deactivate Test 2......................... ");
...
UX_HCD     *hcd;
    ...
    /**************************************************/
    /** Test case: if (transfer_request -> ux_transfer_request_data_pointer != UX_NULL) failure **/
    /** Why direct: there doesn't seem to be a way to set ux_transfer_request_data_pointer to null... **/
    /**************************************************/

    /* Set data pointer to null */
    hid -> ux_host_class_hid_interrupt_endpoint -> ux_endpoint_transfer_request.ux_transfer_request_data_pointer = UX_NULL;
    ...
    /* Wait for device removed signal. */
