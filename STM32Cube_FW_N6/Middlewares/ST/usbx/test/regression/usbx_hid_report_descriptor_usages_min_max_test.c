...
static UCHAR hid_report_descriptor[] = {
    ...
    0x82, 0xab, 0x01,              //   INPUT (Data,Var,Abs)
...
#else
void    usbx_hid_report_descriptor_usages_min_max_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Usages Min Max Test................... ");
...
UX_HOST_CLASS_HID_REPORT            *input_report_descriptor;
    ...
    /* Fill out raw input report buffer to parse. */
    raw_output_report_buffer[0] = 0xaa;
    ...
    if (
        decompressed_output_report_buffer[0] !=  0x000700e0 ||
        decompressed_output_report_buffer[2] !=  0x000700e1 ||
        decompressed_output_report_buffer[4] !=  0x000700e2 ||
        decompressed_output_report_buffer[6] !=  0x000700e3 ||
        decompressed_output_report_buffer[8] !=  0x000700e4 ||
        decompressed_output_report_buffer[10] != 0x000700e5 ||
        decompressed_output_report_buffer[12] != 0x000700e6 ||
        decompressed_output_report_buffer[14] != 0x000700e7
        )
    {
