...
static UCHAR hid_report_descriptor[] = {
    ...
    0xa1, 0x01,                    // COLLECTION (Application)
                                   /*   Use an unknown global tag (0xf9). */
    0xf5, 0x00,                    //   ???
...
#else
void    usbx_hid_report_descriptor_unknown_global_tag_test_application_define(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Unknown Global Tag Test............... ");
