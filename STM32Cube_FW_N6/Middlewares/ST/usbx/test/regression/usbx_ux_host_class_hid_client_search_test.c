...
static UCHAR hid_report_descriptor[] = {
                                   ...
                                   /* Set usage page and usage to unknown values */
    0x07, 0xde, 0xad, 0xbe, 0xef,  // USAGE_PAGE (???)
    0x0b, 0xde, 0xad, 0xbe, 0xef,  // USAGE (???)
...
#else
void    usbx_ux_host_class_hid_client_search_test_application_define(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_client_search.c Test...................... ");
