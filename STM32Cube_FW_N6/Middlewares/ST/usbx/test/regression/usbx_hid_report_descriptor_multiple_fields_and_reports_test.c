...
static UCHAR hid_report_descriptor[] = {
    ...
    0x81, 0x02,                    //   INPUT (Data,Var,Abs)
    0x19, 0x05,                    //   USAGE_MINIMUM (8)
    0x29, 0x07,                    //   USAGE_MAXIMUM (10)
...
#else
void    usbx_hid_report_descriptor_multiple_fields_and_reports_test(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Multiple Fields and Reports Test...... ");
...
UX_HOST_CLASS_HID_FIELD             *report_field;
    ...
    if(
       report_field -> ux_host_class_hid_field_report_size != 16 ||
       report_field -> ux_host_class_hid_field_report_count != 6
       )
    {
