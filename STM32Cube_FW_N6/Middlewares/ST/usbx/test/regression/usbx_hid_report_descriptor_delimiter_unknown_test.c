...
static UCHAR hid_report_descriptor[] = {
    ...
    0xa1, 0x01,                    // COLLECTION (Application)
                                   /*   Use an unknown delimiter value (0x02). */
    0xa9, 0x02,                    //   DELIMITER (???)
...
#else
void    usbx_hid_report_descriptor_delimiter_unknown_test_application_define(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Delimiter Unknown Test................ ");
