...
static UCHAR hid_report_descriptor[] = {
    ...
    0x09, 0x30,                    //   USAGE (X) - Single usage
    0x15, 0x81,                    //   LOGICAL_MINIMUM (-127)
    0x25, 0x7f,                    //   LOGICAL_MAXIMUM (127)
    0x75, 0x08,                    //   REPORT_SIZE (8)
    0x95, 0x03,                    //   REPORT_COUNT (3) - Multiple data
...
#else
void    usbx_hid_report_descriptor_single_usage_multiple_data_test_application_define(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Single Usage Multiple Data Test....................... ");
...
UX_HOST_CLASS_HID_REPORT            *input_report_descriptor;
    ...
    if (
        ...
        decompressed_output_report_buffer[2] !=  0x00010030 ||
        decompressed_output_report_buffer[4] !=  0x00010030
        )
    {
