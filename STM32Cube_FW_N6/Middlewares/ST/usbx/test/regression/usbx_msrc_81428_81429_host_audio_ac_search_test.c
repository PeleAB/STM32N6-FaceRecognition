...
static UX_HOST_CLASS_AUDIO_AC                   *host_audio_ac = UX_NULL;
...
/* ------------------------------------ Interface Descriptor *//* 0 Control (9+126=135) *//* @45 */
...
/* 8 iInterface                                              */ 0,
/* ---------------- Audio 2.0 AC Interface Header Descriptor *//* (9+8+8+7+17*2+18*2+12*2=126) *//* @54 */
...
/* 8 bmControls                                              */ 0x00,
/* -------------------- Audio 2.0 AC Clock Source Descriptor (0x11) *//* @63 */
...
/* -------------------- Audio 2.0 AC Clock Selector Descriptor (1x1, 0x12) *//* @71 */
...
/* -------------------- Audio 2.0 AC Clock Multiplier Descriptor (0x10) *//* @79 */
...
/* ------------------- Audio 2.0 AC Input Terminal Descriptor *//* @86 */
...
/* --------------------- Audio 2.0 AC Feature Unit Descriptor *//* @86+17=103 */
...
/* .  iFeature                                                */ 0,
/* ------------------ Audio 2.0 AC Output Terminal Descriptor *//* @103+18=121 */
...
#define FRAMEWORK_POS_FULL_SPEED_ITD (84)
#define FRAMEWORK_POS_FULL_SPEED_OTD (119)
#define FRAMEWORK_POS_FULL_SPEED_ASD (198) /* IFD::bTerminalLink@4 */
...
/* ------------------- Audio 1.0 AC Input Terminal Descriptor *//* @54 */
...
/* --------------------- Audio 1.0 AC Feature Unit Descriptor *//* @54+12=66 */
/* 0  bLength, bDescriptorType, bDescriptorSubtype            */ 10,   0x24, 0x06,
/* 3  bUnitID, bSourceID                                      */ 0x02, 0x01,
/* 5  bControlSize                                            */ 1,
/* 6  bmaControls(0) ... bmaControls(...) ...                 */ 0x00, 0x00, 0x00,
/* .  iFeature                                                */ 0,
/* ------------------ Audio 1.0 AC Output Terminal Descriptor *//* @66+10=76 */
/* 0  bLength, bDescriptorType, bDescriptorSubtype            */ 9,    0x24,                 0x03,
/* 3  bTerminalID, wTerminalType                              */ 0x03, D0(0x0101),D1(0x0101),
/* 6  bAssocTerminal, bSourceID                               */ 0x00, 0x02,
/* 8  iTerminal                                               */ 0,
/* ------------------- Audio 1.0 AC Input Terminal Descriptor *//* @76+9=85 */
/* 0  bLength, bDescriptorType, bDescriptorSubtype            */ 12,   0x24,                 0x02,
/* 3  bTerminalID, wTerminalType                              */ 0x04, D0(0x0101),D1(0x0101),
/* 6  bAssocTerminal,                                         */ 0x00,
/* 7  bNrChannels, wChannelConfig                             */ 0x02, D0(0),D1(0),
/* 10 iChannelNames, iTerminal                                */ 0,    0,
/* --------------------- Audio 1.0 AC Feature Unit Descriptor *//* @85+12=97 */
/* 0  bLength, bDescriptorType, bDescriptorSubtype            */ 10,   0x24, 0x06,
/* 3  bUnitID, bSourceID                                      */ 0x05, 0x04,
/* 5  bControlSize                                            */ 1,
/* 6  bmaControls(0) ... bmaControls(...) ...                 */ 0x00, 0x00, 0x00,
/* .  iFeature                                                */ 0,
/* ------------------ Audio 1.0 AC Output Terminal Descriptor *//* @97+10=107 */
/* 0  bLength, bDescriptorType, bDescriptorSubtype            */ 9,    0x24,                 0x03,
/* 3  bTerminalID, wTerminalType                              */ 0x06, D0(0x0301),D1(0x0301),
/* 6  bAssocTerminal, bSourceID                               */ 0x00, 0x05,
/* 8  iTerminal                                               */ 0,
/* --------------------- Audio 1.0 AC INT Endpoint Descriptor *//* @107+9=116 */
/* 0  bLength, bDescriptorType                                */ 7,               0x05,
/* 2  bEndpointAddress, bmAttributes                          */ 0x83,            0x03,
/* 4  wMaxPacketSize, bInterval                               */ D0(8),D1(8),     1,

/* ------------------------------------ Interface Descriptor *//* 1 Stream IN (9+9+7+11+9+7=52) *//* @116+7=123 */
/* 0 bLength, bDescriptorType                                */ 9,    0x04,
/* 2 bInterfaceNumber, bAlternateSetting                     */ 1,    0,
/* 4 bNumEndpoints                                           */ 0,
/* 5 bInterfaceClass, bInterfaceSubClass, bInterfaceProtocol */ 0x01, 0x02, 0x00,
/* 8 iInterface                                              */ 0,
/* ------------------------------------ Interface Descriptor *//* @123+9=132 */
/* 0 bLength, bDescriptorType                                */ 9,    0x04,
/* 2 bInterfaceNumber, bAlternateSetting                     */ 1,    1,
/* 4 bNumEndpoints                                           */ 1,
/* 5 bInterfaceClass, bInterfaceSubClass, bInterfaceProtocol */ 0x01, 0x02, 0x00,
/* 8 iInterface                                              */ 0,
/* ------------------------ Audio 1.0 AS Interface Descriptor *//* @132+9=141 */
...
#define FRAMEWORK_POS_FULL_SPEED_ITD10 (54)
#define FRAMEWORK_POS_FULL_SPEED_OTD10 (76)
#define FRAMEWORK_POS_FULL_SPEED_ASD10 (141) /* bTerminalLink@4 */
    ...
    switch(event)
    {
        ...
        case UX_DEVICE_INSERTION:
            ...
            if (ux_host_class_audio_subclass_get(audio) != UX_HOST_CLASS_AUDIO_CLASS)
            {
                ...
                host_audio_ac = (UX_HOST_CLASS_AUDIO_AC *)audio;
            break;
        ...
        case UX_DEVICE_REMOVAL:
            ...
            if (ux_host_class_audio_subclass_get(audio) != UX_HOST_CLASS_AUDIO_CLASS)
            {
                ...
                if (audio == (UX_HOST_CLASS_AUDIO *)host_audio_ac)
...
#else
void usbx_msrc_81428_81429_host_audio_ac_search_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                  memory_pointer;
    ...
    /* Inform user.  */
    printf("Running MSRC 81428/81429 - Audio Host AC Search Test................ ");
...
static UX_INTERFACE           fake_interface;
static UX_HOST_CLASS_AUDIO_AC fake_ac;
static UX_HOST_CLASS    *good_cls;
static UX_CONFIGURATION *good_cfg;
static void _activate_interfaces(UX_INTERFACE *first_interface)
{
UX_INTERFACE *interface_ptr = first_interface;
    ...
    while(interface_ptr)
    {
        ...
        {
            if (interface_ptr -> ux_interface_class)
            {
                ...
                interface_ptr -> ux_interface_class -> ux_host_class_entry_function(&class_command);
            }
        }
        interface_ptr = interface_ptr -> ux_interface_next_interface;
    }
}
static void _deactivate_interfaces(UX_INTERFACE *first_interface)
{
UX_INTERFACE *interface_ptr = first_interface;
    class_command.ux_host_class_command_request = UX_HOST_CLASS_COMMAND_DEACTIVATE;
    while (interface_ptr)
    {
        if (interface_ptr -> ux_interface_class_instance)
        {
            class_command.ux_host_class_command_instance = interface_ptr -> ux_interface_class_instance;
...
/* AC must not be linked if bInterfaceNumber equal but subclass not expected  */
static void _msrc_81428_audio_ac_type_tests(void)
{
    stepinfo(">>>>>>>>>>>> AC Search Test: ifc_n same but subclass mismatch\n");

    stepinfo(">>>>>>>>>>>> AC Search Test: clear class instances\n");
    _deactivate_interfaces(good_cfg -> ux_configuration_first_interface);
    UX_TEST_ASSERT(host_audio_ac == UX_NULL);
    UX_TEST_ASSERT(host_audio_rx == UX_NULL);
    UX_TEST_ASSERT(host_audio_tx == UX_NULL);
    stepinfo(">>>>>>>>>>>> AC Search Test: insert fake class instance in head (IFC 0.1,CLS 2)\n");
    fake_ac.ux_host_class_audio_interface = &fake_interface;
    fake_interface.ux_interface_configuration = good_cfg;
    fake_configuration.ux_configuration_first_interface = &fake_interface;
    fake_configuration.ux_configuration_device = &fake_device;
    fake_interface.ux_interface_descriptor.bInterfaceNumber = 0;
    fake_interface.ux_interface_descriptor.bAlternateSetting = 1;
    fake_interface.ux_interface_descriptor.bInterfaceClass = UX_HOST_CLASS_AUDIO_CLASS;
    fake_interface.ux_interface_descriptor.bInterfaceSubClass = UX_HOST_CLASS_AUDIO_SUBCLASS_STREAMING;
    _ux_host_stack_class_instance_create(good_cls, (VOID *)&fake_ac);
    stepinfo(">>>>>>>>>>>> AC Search Test: create class instance\n");
    _activate_interfaces(good_cfg -> ux_configuration_first_interface);
    stepinfo(">>>>>>>>>>>> AC Search Test: Validate connections\n");
    UX_TEST_ASSERT(host_audio_ac != UX_NULL);
    UX_TEST_ASSERT(host_audio_rx != UX_NULL);
    UX_TEST_ASSERT(host_audio_tx != UX_NULL);
    UX_TEST_ASSERT(host_audio_ac->ux_host_class_audio_as_count == 2);
    UX_TEST_ASSERT(host_audio_ac->ux_host_class_audio_as[0] == host_audio_rx);
    UX_TEST_ASSERT(host_audio_ac->ux_host_class_audio_as[1] == host_audio_tx);
    UX_TEST_ASSERT(host_audio_rx -> ux_host_class_audio_ac == host_audio_ac);
    UX_TEST_ASSERT(host_audio_tx -> ux_host_class_audio_ac == host_audio_ac);
    stepinfo(">>>>>>>>>>>> AC Search Test: clear class instances\n");
    _deactivate_interfaces(good_cfg -> ux_configuration_first_interface);
    UX_TEST_ASSERT(host_audio_ac == UX_NULL);
    UX_TEST_ASSERT(host_audio_rx == UX_NULL);
    UX_TEST_ASSERT(host_audio_tx == UX_NULL);
    stepinfo(">>>>>>>>>>>> AC Search Test: destroy fake class instance\n");
    _ux_host_stack_class_instance_destroy(good_cls, (VOID *)&fake_ac);
    stepinfo(">>>>>>>>>>>> AC Search Test: create class instances\n");
    _activate_interfaces(good_cfg -> ux_configuration_first_interface);
}

/* AC must not be linked if device not the same.  */
static void _msrc_81429_audio_ac_device_tests(void)
{
    stepinfo(">>>>>>>>>>>> AC Search Test: ifc_n same but device/configuration mismatch\n");
    ...
    UX_TEST_ASSERT(host_audio_rx == UX_NULL);
    UX_TEST_ASSERT(host_audio_tx == UX_NULL);
    stepinfo(">>>>>>>>>>>> AC Search Test: insert fake class instance in head (DEV/CFG different)\n");
    fake_ac.ux_host_class_audio_interface = &fake_interface;
    fake_interface.ux_interface_configuration = &fake_configuration;
    fake_configuration.ux_configuration_first_interface = &fake_interface;
    fake_configuration.ux_configuration_device = &fake_device;
    fake_interface.ux_interface_descriptor.bInterfaceNumber = 0;
    fake_interface.ux_interface_descriptor.bAlternateSetting = 0;
    fake_interface.ux_interface_descriptor.bInterfaceClass = UX_HOST_CLASS_AUDIO_CLASS;
    fake_interface.ux_interface_descriptor.bInterfaceSubClass = UX_HOST_CLASS_AUDIO_SUBCLASS_CONTROL;
    _ux_host_stack_class_instance_create(good_cls, (VOID *)&fake_ac);
    stepinfo(">>>>>>>>>>>> AC Search Test: create class instances\n");
    _activate_interfaces(good_cfg -> ux_configuration_first_interface);
    stepinfo(">>>>>>>>>>>> AC Search Test: Validate connections\n");
...
ULONG                                               temp;
    ...
    _memory_tests();
    good_cls = host_audio_ac -> ux_host_class_audio_class;
    good_cfg = host_audio_ac -> ux_host_class_audio_interface -> ux_interface_configuration;

    _msrc_81428_audio_ac_type_tests();
    _msrc_81429_audio_ac_device_tests();
