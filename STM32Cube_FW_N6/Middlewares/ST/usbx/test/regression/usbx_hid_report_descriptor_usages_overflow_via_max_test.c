...
static UCHAR hid_report_descriptor[] = {
    ...
    0xa1, 0x01,                    // COLLECTION (Application)
                                   ...
                                   /*   Add the maximum number of usages. */
    0x19, 0x00,                    //   USAGE_MINIMUM (0)
    0x2a, 0xff, 0x04,              //   USAGE_MAXIMUM (1024)
...
#else
void    usbx_hid_report_descriptor_usages_overflow_via_max_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Usages Overflow Via Max Test....................... ");
