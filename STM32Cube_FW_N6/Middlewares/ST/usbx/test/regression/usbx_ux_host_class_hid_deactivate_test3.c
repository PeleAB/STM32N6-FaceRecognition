...
#else
void    usbx_ux_host_class_hid_deactivate_test3_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_deactivate Test 3......................... ");
...
UX_HOST_CLASS_COMMAND               command;
    ...
    command.ux_host_class_command_instance = hid;
