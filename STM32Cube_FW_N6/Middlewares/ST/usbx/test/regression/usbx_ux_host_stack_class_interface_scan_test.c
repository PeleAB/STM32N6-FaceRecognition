...
static UCHAR                           test_error_cases = UX_FALSE;
static UCHAR                           dpump_entry_error = UX_FALSE;
...
#else
void    usbx_ux_host_stack_class_interface_scan_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_DPUMP_PARAMETER  parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_interface_scan Test..................... ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_interface_scan Test..................... ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_interface_scan Test..................... ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_interface_scan Test..................... ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_interface_scan Test..................... ERROR #6\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_interface_scan Test..................... ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_interface_scan Test..................... ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_interface_scan Test..................... ERROR #8\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_class_interface_scan Test..................... ERROR #9\n");
        test_control_return(1);
    }
}
...
UX_DEVICE       device_backup;
    ...
    /* Inform user.  */
    printf("Running ux_host_stack_class_interface_scan Test..................... ");
    ...
    /* Simulate _ux_host_stack_class_interface_scan error cases. */

    /* Backup device instance. */
    ux_utility_memory_copy(&device_backup, device, sizeof(device_backup));

    /* Simulate error: no configuration. */
    device->ux_device_first_configuration = UX_NULL;
    status = _ux_host_stack_class_interface_scan(device);
    if (status == UX_SUCCESS)
    {

        printf("ERROR #%d: Expects error since no configuration\n", __LINE__);
        error_counter ++;
    }

    /* Restore device instance. */
    ux_utility_memory_copy(device, &device_backup, sizeof(device_backup));

    /* Disconnect. */
    ux_test_dcd_sim_slave_disconnect();
    ux_test_hcd_sim_host_disconnect();
    dpump_entry_error = UX_TRUE;
    ...
    {
        printf("ERROR #%d: expects error\n", __LINE__);
        error_counter ++;
    }
    dpump_entry_error = UX_FALSE;
