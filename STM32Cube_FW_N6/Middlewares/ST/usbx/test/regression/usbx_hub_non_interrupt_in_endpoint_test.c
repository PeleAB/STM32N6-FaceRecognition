...
static unsigned char framework_non_interrupt_in_endpoint[] = {
...
static DEVICE_INIT_DATA device_init_data = {
    .dont_enumerate = 1,
    .framework = framework_non_interrupt_in_endpoint,
    .framework_length = sizeof(framework_non_interrupt_in_endpoint),
};

#ifdef CTEST
void test_application_define(void *first_unused_memory)
#else
void usbx_hub_non_interrupt_in_endpoint_test_application_define(void *first_unused_memory)
#endif
{

    /* Inform user.  */
    printf("Running Hub Non Interrupt In Endpoint Test.......................... ");
