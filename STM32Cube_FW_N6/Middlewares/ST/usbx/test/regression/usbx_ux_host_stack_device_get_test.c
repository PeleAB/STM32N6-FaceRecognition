...
#else
void    usbx_ux_host_stack_device_get_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_DPUMP_PARAMETER  parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_device_get Test............................... ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_device_get Test............................... ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_device_get Test............................... ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_device_get Test............................... ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_device_get Test............................... ERROR #6\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_device_get Test............................... ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_device_get Test............................... ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_device_get Test............................... ERROR #8\n");
        test_control_return(1);
    }
}
...
UINT            status;
UX_HOST_CLASS   *class;
UX_DEVICE       *test_device;

    /* Inform user.  */
    printf("Running ux_host_stack_device_get Test............................... ");
    ...
    /* At this point, the data pump class has been found.  Now get the first
       device using ux_host_stack_device_get.  */
    status = ux_host_stack_device_get(0, &test_device);
    if (status != UX_SUCCESS)
    {
    ...
    /* Check if we get correct device.  */
    if (test_device != dpump -> ux_host_class_dpump_device)
    {
    ...
    /* Call ux_host_stack_device_get with device index 1.  */
    status = ux_host_stack_device_get(1, &test_device);
    ...
    /* Call ux_host_stack_device_get with device index exceeding maximum.  */
    status = ux_host_stack_device_get(100, &test_device);
    if (status != UX_DEVICE_HANDLE_UNKNOWN)
    {
