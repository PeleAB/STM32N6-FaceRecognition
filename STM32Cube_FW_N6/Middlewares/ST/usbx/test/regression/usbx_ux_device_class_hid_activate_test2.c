...
static UCHAR device_framework_full_speed[DEVICE_FRAMEWORK_LENGTH_FULL_SPEED] = {
    ...
    /* Endpoint descriptor */
        0x07, 0x05,
        0x02, /* Set direction to OUT, which is wrong. */
        0x03, 0x08, 0x00, 0x08
...
#else
void    usbx_ux_device_class_hid_activate_test2_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_device_class_hid_activate Test 2....................... ");
