...
#else
void    usbx_ux_host_class_hid_mouse_buttons_get_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_mouse_buttons_get Test.................... ");
...
ULONG                               mouse_buttons;
    ...
    status = _ux_host_class_hid_mouse_buttons_get(&fake_mouse, &mouse_buttons);
