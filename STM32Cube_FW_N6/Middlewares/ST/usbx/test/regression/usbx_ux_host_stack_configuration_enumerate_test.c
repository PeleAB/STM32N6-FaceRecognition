...
static UX_TEST_HCD_SIM_ACTION get_cfg_desc_len_error[] = {
...
{   UX_HCD_TRANSFER_REQUEST, &_GetConfigDescriptor,
        UX_FALSE, 0,
        UX_TEST_SIM_REQ_ANSWER | UX_TEST_SETUP_MATCH_REQ_V, 0, device_framework_full_speed + 18, UX_CONFIGURATION_DESCRIPTOR_LENGTH - 1, 0,
        UX_SUCCESS, UX_NULL},
{   0   }
};
...
#else
void    usbx_ux_host_stack_configuration_enumerate_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_HID_PARAMETER    hid_parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_enumerate Test.................. ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_enumerate Test.................. ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_enumerate Test.................. ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_enumerate Test.................. ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_enumerate Test.................. ERROR #6\n");
        test_control_return(1);
    }
#endif
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_enumerate Test.................. ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_enumerate Test.................. ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_enumerate Test.................. ERROR #8\n");
        test_control_return(1);
    }
}
...
static void  ux_test_thread_simulation_0_entry(ULONG arg)
{
    ...
    /* Inform user.  */
    printf("Running ux_host_stack_configuration_enumerate Test.................. ");

    /* Simulate GetConfiguration length error. */
    ux_test_hcd_sim_host_set_actions(get_cfg_desc_len_error);
