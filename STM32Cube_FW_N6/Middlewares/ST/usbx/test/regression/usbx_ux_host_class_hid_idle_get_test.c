...
#else
void    usbx_ux_host_class_hid_idle_get_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_idle_get Test............................. ");
...
UX_MEMORY_BLOCK                *original_cache_safe_memory_block = (UX_MEMORY_BLOCK *)_ux_system -> ux_system_memory_byte_pool[UX_MEMORY_BYTE_POOL_CACHE_SAFE] -> ux_byte_pool_start;
    ...
    /**************************************************/
    /** Test case: Basic, successful test. **/
    /**************************************************/
    ...
    status = _ux_host_class_hid_idle_get(hid, &idle_time, 0);
    ...
    /**************************************************/
    /** Test case: idle_byte =  _ux_utility_memory_allocate(UX_SAFE_ALIGN, UX_CACHE_SAFE_MEMORY, 1); fails **/
    /**************************************************/
    ...
    /**************************************************/
    /** Test case: _ux_host_stack_class_instance_verify(_ux_system_host_class_hid_name, (VOID *) hid) fails. **/
    /**************************************************/

    status = ux_host_class_hid_idle_get(UX_NULL, UX_NULL, 0);
    if (status == UX_SUCCESS)
    {
    ...
    /**************************************************/
    /** Test case: (transfer_request -> ux_transfer_request_actual_length == 1) fails in **/
    /** if ((status == UX_SUCCESS) && (transfer_request -> ux_transfer_request_actual_length == 1)) **/
    /**************************************************/
