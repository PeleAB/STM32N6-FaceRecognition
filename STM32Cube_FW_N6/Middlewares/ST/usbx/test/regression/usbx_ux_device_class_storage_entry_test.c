...
#else
void    usbx_ux_device_class_storage_entry_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_device_class_storage_entry Test.......................... ");
    stepinfo("\n");
...
UX_SLAVE_CLASS_COMMAND                      slave_command;
    ...
    /* UX_NO_CLASS_MATCH.  */
    slave_command.ux_slave_class_command_request = UX_SLAVE_CLASS_COMMAND_QUERY;
    slave_command.ux_slave_class_command_class   = UX_SLAVE_CLASS_STORAGE_CLASS + 1;
    status = ux_device_class_storage_entry(&slave_command);
    ...
    slave_command.ux_slave_class_command_request = 0xFF;
    status = ux_device_class_storage_entry(&slave_command);
