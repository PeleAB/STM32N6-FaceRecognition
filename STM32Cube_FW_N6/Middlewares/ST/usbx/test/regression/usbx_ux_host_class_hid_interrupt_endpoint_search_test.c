...
#else
void    usbx_ux_host_class_hid_interrupt_endpoint_search_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_interrupt_endpoint_search Test....................... ");
...
UX_MEMORY_BLOCK                    *original_cache_safe_memory_block = (UX_MEMORY_BLOCK *)_ux_system -> ux_system_memory_byte_pool[UX_MEMORY_BYTE_POOL_CACHE_SAFE] -> ux_byte_pool_start;
    ...
    /**************************************************/
    /** Test case: ux_utility_memory_allocate() fails **/
    /**************************************************/
    ...
    /**************************************************/
    /** Test case: _ux_host_stack_interface_endpoint_get() fails. **/
    /** NOTE: only reasonable way for _ux_host_stack_interface_endpoint_get() to fail is if there are no endpoints, which is unreasonable. **/
    /**************************************************/

    /* Set the endpoint to null so we don't find it. */
    tmp = (ALIGN_TYPE)hid -> ux_host_class_hid_interface -> ux_interface_first_endpoint;
    hid -> ux_host_class_hid_interface -> ux_interface_first_endpoint = UX_NULL;
    ...
    /* Restore state for next test. */
    hid -> ux_host_class_hid_interface -> ux_interface_first_endpoint = (VOID *)tmp;

    /**************************************************/
    /** Test case: **/
    /** if (!(((hid -> ux_host_class_hid_interrupt_endpoint -> ux_endpoint_descriptor.bEndpointAddress & UX_ENDPOINT_DIRECTION) == UX_ENDPOINT_IN) && **/
    /**      ((hid -> ux_host_class_hid_interrupt_endpoint -> ux_endpoint_descriptor.bmAttributes & UX_MASK_ENDPOINT_TYPE) == UX_INTERRUPT_ENDPOINT))) **/
    /** NOTE: USBX requires the first endpoint to be INTERRUPT and IN. **/
    /**************************************************/

    /* Clear the IN bit. */
    tmp = hid -> ux_host_class_hid_interrupt_endpoint -> ux_endpoint_descriptor.bEndpointAddress;
    hid -> ux_host_class_hid_interrupt_endpoint -> ux_endpoint_descriptor.bEndpointAddress &= (~UX_ENDPOINT_IN);
    ...
    /* Restore state for next test. */
    hid -> ux_host_class_hid_interrupt_endpoint -> ux_endpoint_descriptor.bEndpointAddress = (ULONG)tmp;
