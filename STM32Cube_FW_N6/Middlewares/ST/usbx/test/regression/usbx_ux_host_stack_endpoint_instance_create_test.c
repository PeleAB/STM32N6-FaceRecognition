...
static UCHAR iso_ep_desc[] =
{
    /* Endpoint descriptor (ISO) */
    0x07, 0x05, 0x01, 0x01, 0x00, 0x01, 0x00,
};
...
static UX_TEST_HCD_SIM_ACTION endpoint_create_fail[] = {
...
#else
void    usbx_ux_host_stack_endpoint_instance_create_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_DPUMP_PARAMETER  parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_create Test................. ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_create Test................. ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_create Test................. ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_create Test................. ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_create Test................. ERROR #6\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_create Test................. ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_create Test................. ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_create Test................. ERROR #8\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_endpoint_instance_create Test................. ERROR #9\n");
        test_control_return(1);
    }
}
...
UX_HCD          *hcd;
    ...
    /* Inform user.  */
    printf("Running ux_host_stack_endpoint_instance_create Test................. ");
    ...
    /* Simulate _ux_host_stack_endpoint_instance_create error cases. */
    hcd =  &_ux_system_host -> ux_system_host_hcd_array[0];
    endpoint.ux_endpoint_device = device;

    _ux_utility_descriptor_parse(iso_ep_desc, _ux_system_endpoint_descriptor_structure,
                                 UX_ENDPOINT_DESCRIPTOR_ENTRIES, (UCHAR *) &endpoint.ux_endpoint_descriptor);

    test_error_cases = UX_TRUE;

    /* Simulate endpoint creation error. */
    ux_test_hcd_sim_host_set_actions(endpoint_create_fail);
...
#if UX_MAX_DEVICES > 1
    /* Simulate bandwidth error: available bandwidth is 0. */
    hcd -> ux_hcd_available_bandwidth = 0;

    status = _ux_host_stack_endpoint_instance_create(&endpoint);
    if (status != UX_NO_BANDWIDTH_AVAILABLE)
    {

        printf("ERROR #%d: expect UX_NO_BANDWIDTH_AVAILABLE but got %x\n", __LINE__, status);
        error_counter ++;
    }
#endif
