...
#else
void    usbx_ux_host_stack_interface_endpoint_get_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_DPUMP_PARAMETER  parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interface_endpoint_get Test................... ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interface_endpoint_get Test................... ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interface_endpoint_get Test................... ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interface_endpoint_get Test................... ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interface_endpoint_get Test................... ERROR #6\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interface_endpoint_get Test................... ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interface_endpoint_get Test................... ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interface_endpoint_get Test................... ERROR #8\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_interface_endpoint_get Test................... ERROR #9\n");
        test_control_return(1);
    }
}
...
ULONG             interface_handler;

    /* Inform user.  */
    printf("Running ux_host_stack_interface_endpoint_get Test................... ");
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("ERROR #%d: fail to get configuration instance\n", __LINE__);
        test_control_return(1);
    }

    status = ux_host_stack_configuration_interface_get(configuration, 0, 0, &interface);
    if (status != UX_SUCCESS)
    {

        printf("ERROR #%d: fail to get interface instance\n", __LINE__);
        test_control_return(1);
    }

    /* Simulate _ux_host_stack_interface_endpoint_get error cases. */

    /* Expecting errors. */
    test_error_cases = UX_TRUE;

    /* Simulate invalid interface. */
    interface_handler = interface->ux_interface_handle;
    interface->ux_interface_handle = 0;
    status = _ux_host_stack_interface_endpoint_get(interface, 0, &endpoint);
    if (status != UX_INTERFACE_HANDLE_UNKNOWN)
    {

        printf("ERROR #%d: expect interface error but got %x\n", __LINE__, status);
        error_counter ++;
    }
    interface->ux_interface_handle = interface_handler;

    /* Simulate invalid endpoint index. */
    status = _ux_host_stack_interface_endpoint_get(interface, 10, &endpoint);
    if (status != UX_ENDPOINT_HANDLE_UNKNOWN)
    {

        printf("ERROR #%d: expect endpoint error but got %x\n", __LINE__, status);
        error_counter ++;
    }
