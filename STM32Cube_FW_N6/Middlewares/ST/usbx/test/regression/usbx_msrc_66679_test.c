...
#else
void    usbx_msrc_66679_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                  memory_pointer;
    ...
    printf("Running MSRC 66679 Test............................................. ");
...
UX_SLAVE_TRANSFER                                  *slave_transfer_request;
    ...
    stepinfo(">>>>>>>>>>>>>>>> Test MSRC Error cases\n");
    /*
    ...
    */
    vendor_req_rc = UX_SUCCESS;
    vendor_req_ret_len = 8;
    transfer_request -> ux_transfer_request_requested_length = 0xFFFF;
    status = ux_host_stack_transfer_request(transfer_request);
    UX_TEST_ASSERT(status == UX_SUCCESS);
    UX_TEST_ASSERT(vendor_req_buf_len <= UX_SLAVE_REQUEST_CONTROL_MAX_LENGTH);
    UX_TEST_ASSERT(vendor_req_req_len == transfer_request -> ux_transfer_request_requested_length);
    UX_TEST_ASSERT(transfer_request -> ux_transfer_request_actual_length == vendor_req_ret_len);
