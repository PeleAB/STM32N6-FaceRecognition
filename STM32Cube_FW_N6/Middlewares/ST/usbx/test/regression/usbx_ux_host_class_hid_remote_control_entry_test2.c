...
#else
void    usbx_ux_host_class_hid_remote_control_entry_test2_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_remote_control_entry Test 2............... ");
