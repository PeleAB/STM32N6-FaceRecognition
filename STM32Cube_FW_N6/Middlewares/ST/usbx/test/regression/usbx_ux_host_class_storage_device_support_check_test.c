...
#else
void    usbx_ux_host_class_storage_device_support_check_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_storage_device_support_check Test............. ");
    stepinfo("\n");
...
ULONG                                       temp;
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_device_support_check - Protocol FAIL\n");
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_device_support_check - SubClass FAIL\n");

    temp = storage -> ux_host_class_storage_interface -> ux_interface_descriptor.bInterfaceSubClass;
    storage -> ux_host_class_storage_interface -> ux_interface_descriptor.bInterfaceSubClass = 0xAA;
    ...
    storage -> ux_host_class_storage_interface -> ux_interface_descriptor.bInterfaceSubClass = temp;
