...
static UCHAR device_framework_full_speed[] = {
    ...
    /* Configuration descriptor 9 bytes */
    CFG_DESC(CFG_DESC_LEN + 2*DPUMP_IFC_DESC_ALL_LEN + HID_MOUSE_IFC0_DESC_ALL_LEN + HID_MOUSE_IFC1_DESC_ALL_LEN, 2, 1)
    /* DPUMP 9+9+7      =25 */
    DPUMP_IFC_DESC_ALL(0, 0x81, 0x02)
    DPUMP_IFC_DESC_ALL(1, 0x83, 0x04)
    /* HID   9+9 + 9+9+7=43 */
    HID_MOUSE_IFC0_DESC_ALL(2)
    HID_MOUSE_IFC1_DESC_ALL(2, 0x85)
};
...
#else
void    usbx_ux_device_stack_interface_delete_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_HID_PARAMETER    hid_parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_delete Test....................... ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_delete Test....................... ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_delete Test....................... ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_delete Test....................... ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_delete Test....................... ERROR #6\n");
        test_control_return(1);
    }
#endif
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_delete Test....................... ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_delete Test....................... ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_device_stack_interface_delete Test....................... ERROR #8\n");
        test_control_return(1);
    }
}
...
UX_SLAVE_INTERFACE      *interfaces[3];
INT                      i;

    /* Inform user.  */
    printf("Running ux_device_stack_interface_delete Test....................... ");
    ...
    /* Confirm at least 3 interfaces are connected. */
    ...
    if (i < 3)
    {
        ...
        printf("ERROR #%d: expect 3 interfaces or more\n", __LINE__);
        test_control_return(1);
    }
#endif
#if 0 /* USBX-102 we are not supporting this case (delete from tail). */
    /* Delete interface from last one. */
    for (; i; i --)
    {

        interface = interfaces[i - 1];
        status = _ux_device_stack_interface_delete(interface);
        if (status != UX_SUCCESS)
        {

            printf("ERROR #%d: interface %d delete fail\n", __LINE__, i);
            error_counter ++;
        }
    }
#endif
