...
#else
void    usbx_ux_host_class_hid_mouse_positions_get_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_mouse_positions_get Test.................. ");
...
UX_HOST_CLASS_HID_MOUSE             fake_mouse;
...
SLONG                               mouse_y_position;
    ...
    fake_mouse.ux_host_class_hid_mouse_hid = &fake_hid;

    status = _ux_host_class_hid_mouse_position_get(&fake_mouse, &mouse_x_position, &mouse_y_position);
