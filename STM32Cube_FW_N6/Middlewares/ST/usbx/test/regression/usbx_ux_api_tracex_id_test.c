...
#else
void    usbx_ux_api_tracex_id_test_application_define(void *first_unused_memory)
#endif
{
...
UINT status;
    ...
    /* Inform user.  */
    printf("Running usbx_ux_api_tracex_id Test.................................. ");
...
UINT      tracex_id = 0;
#if defined(TX_ENABLE_EVENT_TRACE) && defined(UX_TRACE_INSERT_MACROS)
    /* The fix is to make sure below trace ID are different, if it is not fixed, the compile will fail*/
    switch(tracex_id){
