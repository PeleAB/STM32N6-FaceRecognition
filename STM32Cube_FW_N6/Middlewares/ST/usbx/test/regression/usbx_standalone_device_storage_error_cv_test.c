...
#else
void    usbx_standalone_device_storage_error_cv_test_application_define(void *first_unused_memory)
#endif
{
...
ULONG                           test_n;
    ...
    /* Inform user.  */
    printf("Running STANDALONE Device Storage ERROR & CV Test................... ");
...
UX_SLAVE_CLASS_STORAGE                      *slave_storage;
    ...
    printf(">>>>>>>>>>>>>>> UX_SLAVE_CLASS_STORAGE_SCSI_WRITE16 - WP fail\n");
    slave_device =  &_ux_system_slave->ux_system_slave_device;
    slave_class = _ux_system_slave->ux_system_slave_interface_class_array[0];
    slave_storage = (UX_SLAVE_CLASS_STORAGE *)slave_class->ux_slave_class_instance;
