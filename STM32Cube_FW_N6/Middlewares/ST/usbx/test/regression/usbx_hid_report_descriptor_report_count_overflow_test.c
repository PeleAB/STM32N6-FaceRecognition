...
static UCHAR hid_report_descriptor[] = {
    ...
    0x96, (UCHAR)(UX_HOST_CLASS_HID_USAGES + 1),   //   REPORT_COUNT (UX_HOST_CLASS_HID_USAGES + 1)
...
#else
void    usbx_hid_report_descriptor_report_count_overflow_test_application_define(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Report Count Overflow Test............ ");
