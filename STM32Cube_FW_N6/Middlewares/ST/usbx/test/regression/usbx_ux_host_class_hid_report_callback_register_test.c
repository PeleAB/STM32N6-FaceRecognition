...
#else
void    usbx_ux_host_class_hid_report_callback_register_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_report_callback_register Test............. ");
...
UINT status;
UX_HOST_CLASS_HID_REPORT_CALLBACK   hid_report_callback;
ULONG                               tmp;
    ...
    status = _ux_host_class_hid_report_callback_register(hid, UX_NULL);
    ...
    /**************************************************/
    /** Test case: _ux_utility_semaphore_get() fails. **/
    /**************************************************/

    /* Change semaphore ID to generate error.  */
    ...
    /**************************************************/
    /** Test case: Can't find report with specified report id. **/
    /** Why direct: Normally, the id passed to this function is the id of an already-found report, so it will always find it. **/
    /**************************************************/

    /* Set an unknown report id. */
    hid_report_callback.ux_host_class_hid_report_callback_id = 0xdeadbeef;
