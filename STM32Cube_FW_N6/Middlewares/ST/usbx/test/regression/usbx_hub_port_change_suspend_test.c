...
#else
void usbx_hub_port_change_suspend_test_application_define(void *first_unused_memory)
#endif
{

    /* Inform user.  */
    printf("Running Hub Port Suspend Enable Test................................ ");
...
static void post_init_host()
{
    ...
    UX_TEST_ASSERT((g_hub_device->port_change & UX_HOST_CLASS_HUB_PORT_CHANGE_SUSPEND) == 0);
#endif
}
