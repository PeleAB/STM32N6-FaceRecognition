...
#else
void    usbx_ux_host_class_storage_activate_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_storage_activate Test......................... ");
    stepinfo("\n");
...
UX_HOST_CLASS_COMMAND                       command;
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_activate - configure - configuration_get FAIL\n");
    ...
    command.ux_host_class_command_container = (VOID *)interface;
    command.ux_host_class_command_class_ptr = (VOID *)class;
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_activate - semaphore - semaphore create FAIL\n");

    ux_test_utility_sim_sem_create_count_reset();
    ux_test_utility_sim_sem_error_generation_start(0);
