...
#else
void    usbx_ux_host_class_hid_keyboard_entry_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_keyboard_entry Test....................... ");
...
UX_HOST_CLASS_HID_CLIENT_COMMAND    client_command;
    ...
    /**************************************************/
    /** Test case: no match in switch (command -> ux_host_class_hid_client_command_request). **/
    /**************************************************/

    /* Set to unknown command request. */
    client_command.ux_host_class_hid_client_command_request = 0xdeadbeef;

    status = _ux_host_class_hid_keyboard_entry(&client_command);
    if (status != UX_ERROR)
    {
    ...
    /**************************************************/
    /** Test case: ux_host_class_hid_client_command_page/ux_host_class_hid_client_command_usage error. **/
    /**************************************************/

    /* Set to unknown command request. */
    client_command.ux_host_class_hid_client_command_request = UX_HOST_CLASS_COMMAND_QUERY;
    client_command.ux_host_class_hid_client_command_page = UX_HOST_CLASS_HID_PAGE_GENERIC_DESKTOP_CONTROLS;
    client_command.ux_host_class_hid_client_command_usage = UX_HOST_CLASS_HID_GENERIC_DESKTOP_KEYBOARD + 1;
