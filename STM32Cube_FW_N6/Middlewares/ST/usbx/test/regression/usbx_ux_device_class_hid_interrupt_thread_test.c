...
#else
void    usbx_ux_device_class_hid_interrupt_thread_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_device_class_hid_interrupt_thread Test................... ");
...
UX_SLAVE_TRANSFER      *transfer_request;
    ...
    /* Is this from the interrupt thread? */
    if ((function == UX_DCD_TRANSFER_REQUEST) &&
        (*(ULONG *)transfer_request -> ux_slave_transfer_request_data_pointer == 0xdeadbeef))
...
UX_SLAVE_CLASS_HID_EVENT        hid_event;
    ...
    /**************************************************/
    /** Test case: _ux_device_stack_transfer_request fails. **/
    /**************************************************/

    /* Override device's entry function to intercept specific transfer request. */
    ...
    *(ULONG *)hid_event.ux_device_class_hid_event_buffer = 0xdeadbeef;
    ...
    /* Wait for error in callback. */
    while (callback_error_code != UX_ERROR)
    ...
    /**************************************************/
    /** Test case: _ux_utility_thread_suspend() is called (meaning the device gets unconfigured). **/
    /**************************************************/

    /* Now disconnect the device. This is to get it out of the configured state.  */
    ...
    *(ULONG *)hid_event.ux_device_class_hid_event_buffer = 0xdeadbeef;
    ...
    /* We have no way of checking if this succeeds... */
    ux_utility_thread_sleep(10);
