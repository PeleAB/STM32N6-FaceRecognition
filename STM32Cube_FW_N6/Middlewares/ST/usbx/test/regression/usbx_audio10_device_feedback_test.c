...
/* 2 wTotalLength                                            */ D0(194+18),D1(194+18),
...
/* 4  wMaxPacketSize, bInterval, bRefresh, bSynchAddress      */ D0(256),D1(256), 1,    0, 0x01,
...
/* --------------------- Audio 1.0 AS ISO Feedback Endpoint Descriptor */
/* 0  bLength, bDescriptorType                                */ 9,               0x05,
/* 2  bEndpointAddress, bmAttributes                          */ 0x01,            0x01,
/* 4  wMaxPacketSize, bInterval, bRefresh, bSynchAddress      */ D0(4),D1(4), 1,  4, 0x00,
...
/* 4  wMaxPacketSize, bInterval, bRefresh, bSynchAddress      */ D0(256),D1(256), 1,    0, 0x82,
/* ---------- Audio 1.0 AS ISO Audio Data Endpoint Descriptor */
/* 0  bLength, bDescriptorType, bDescriptorSubtype            */ 7,                0x25, 0x01,
/* 3  bmAttributes                                            */ 0x00,
/* 5  bLockDelayUnits, wLockDelay                             */ 0x00, D0(0),D1(0),
/* --------------------- Audio 1.0 AS ISO Feedback Endpoint Descriptor */
/* 0  bLength, bDescriptorType                                */ 9,               0x05,
/* 2  bEndpointAddress, bmAttributes                          */ 0x82,            0x01,
/* 4  wMaxPacketSize, bInterval, bRefresh, bSynchAddress      */ D0(4),D1(4), 1,  4, 0x00,
};
...
#else
void    usbx_audio10_device_feedback_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                  memory_pointer;
    ...
    /* Inform user.  */
#if !UX_TEST_MULTI_IFC_ON || !UX_TEST_MULTI_ALT_ON || !UX_TEST_MULTI_CLS_ON || !UX_TEST_MULTI_EP_OVER(4) || !defined(UX_DEVICE_BIDIRECTIONAL_ENDPOINT_SUPPORT)
    printf("Running Audio 1.0 Device Feedback Functionality Test................SKIP SUCCESS!\n");
    test_control_return(0);
    return;
#endif

    printf("Running Audio 1.0 Device Feedback Functionality Test................ ");
...
#else
    slave_audio_tx_stream_parameter.ux_device_class_audio_stream_parameter_task_function = ux_device_class_audio_write_task_function;
#endif
#if defined(UX_DEVICE_CLASS_AUDIO_FEEDBACK_SUPPORT)
#if !defined(UX_DEVICE_STANDALONE)
    slave_audio_tx_stream_parameter.ux_device_class_audio_stream_parameter_feedback_thread_entry = ux_device_class_audio_feedback_thread_entry;
#else
    slave_audio_tx_stream_parameter.ux_device_class_audio_stream_parameter_feedback_task_function = _ux_device_class_audio_feedback_task_function;
#endif
#endif
...
#else
    slave_audio_rx_stream_parameter.ux_device_class_audio_stream_parameter_task_function = ux_device_class_audio_read_task_function;
#endif
#if defined(UX_DEVICE_CLASS_AUDIO_FEEDBACK_SUPPORT)
#if !defined(UX_DEVICE_STANDALONE)
    slave_audio_rx_stream_parameter.ux_device_class_audio_stream_parameter_feedback_thread_entry = ux_device_class_audio_feedback_thread_entry;
#else
    slave_audio_rx_stream_parameter.ux_device_class_audio_stream_parameter_feedback_task_function = _ux_device_class_audio_feedback_task_function;
#endif
#endif
...
ULONG                                               temp;
    ...
    /* Read/write feedback test, pass any data of 4 bytes.  */
    _ux_system_slave->ux_system_slave_speed = UX_HIGH_SPEED_DEVICE;
    slave_audio_rx_stream->ux_device_class_audio_stream_feedback->ux_slave_endpoint_transfer_request.ux_slave_transfer_request_requested_length = 4;
    slave_audio_tx_stream->ux_device_class_audio_stream_feedback->ux_slave_endpoint_transfer_request.ux_slave_transfer_request_requested_length = 4;
    temp = 0x1234567;
    ux_device_class_audio_feedback_set(slave_audio_rx_stream, (UCHAR *)&temp);
    temp = device_audio_rx_feedback_count;
    while(device_audio_rx_feedback_count == temp)
        tx_thread_sleep(1);
    UX_TEST_ASSERT(device_audio_rx_feedback == 0x1234567);

    device_audio_tx_feedback = 0xabcd1234;
    temp = device_audio_tx_feedback_count;
    while(device_audio_tx_feedback_count != (temp + 2))
        tx_thread_sleep(1);
    status = ux_device_class_audio_feedback_get(slave_audio_tx_stream, (UCHAR *)&temp);
    UX_TEST_CHECK_SUCCESS(status);
    UX_TEST_ASSERT(temp == 0xabcd1234);

    /* Read/write feedback test full speed, pass any data of 3 bytes.  */
    _ux_system_slave->ux_system_slave_speed = UX_FULL_SPEED_DEVICE;
    slave_audio_rx_stream->ux_device_class_audio_stream_feedback->ux_slave_endpoint_transfer_request.ux_slave_transfer_request_requested_length = 3;
    slave_audio_tx_stream->ux_device_class_audio_stream_feedback->ux_slave_endpoint_transfer_request.ux_slave_transfer_request_requested_length = 3;
    temp = 0x7654321;
    ux_device_class_audio_feedback_set(slave_audio_rx_stream, (UCHAR *)&temp);
    temp = device_audio_rx_feedback_count;
    while(device_audio_rx_feedback_count == temp)
        tx_thread_sleep(1);
    UX_TEST_ASSERT(device_audio_rx_feedback == 0x654321);

    device_audio_tx_feedback = 0x4321dcba;
    temp = device_audio_tx_feedback_count;
    while(device_audio_tx_feedback_count != (temp + 2))
        tx_thread_sleep(1);
    status = ux_device_class_audio_feedback_get(slave_audio_tx_stream, (UCHAR *)&temp);
    UX_TEST_CHECK_SUCCESS(status);
    UX_TEST_ASSERT(temp == 0x21dcba);
#endif
