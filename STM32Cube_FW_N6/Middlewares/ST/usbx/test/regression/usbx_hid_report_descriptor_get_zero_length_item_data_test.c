...
#else
void    usbx_hid_report_descriptor_get_zero_length_item_data_test_application_define(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Get Zero Length Item Data Test........ ");
