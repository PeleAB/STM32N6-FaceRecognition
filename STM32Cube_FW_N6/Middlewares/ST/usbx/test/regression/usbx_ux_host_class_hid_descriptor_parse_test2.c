...
static UINT     get_config_desc_count;
    ...
    case UX_HCD_TRANSFER_REQUEST:
        ...
        /* Is this the transfer request for GetConfigDescriptor? */
            ...
            transfer_request -> ux_transfer_request_index == 0)
        {
            ...
            /* We're looking for the second time we get the config descriptor (_descriptor_parse is the second time). */
            get_config_desc_count++;
            if (get_config_desc_count == 2)
            {
...
#else
void    usbx_ux_host_class_hid_descriptor_parse_test2_application_define(void *first_unused_memory)
#endif
{
...
ALIGN_TYPE                      tmp;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_descriptor_parse Test 2................... ");
    ...
    /**************************************************/
    /** Test case: transfer_request -> ux_transfer_request_actual_length == UX_CONFIGURATION_DESCRIPTOR_LENGTH fails in **/
