...
#else
void    usbx_ux_host_class_hid_entry_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_entry Test................................ ");
...
static UX_HOST_CLASS host_class;
...
UX_HOST_CLASS_COMMAND               command;
    ...
    /**************************************************/
    /** Test case: no match in switch (command -> ux_host_class_command_request). **/
    /**************************************************/

    /* Set an unknown command request. */
    command.ux_host_class_command_request = 0xff;

    status = _ux_host_class_hid_entry(&command);
