...
#else
void    usbx_ux_host_class_hid_periodic_report_stop_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_periodic_report_stop Test................. ");
...
ULONG                               tmp;
    ...
    /**************************************************/
    /** Test case: if (hid -> ux_host_class_hid_interrupt_endpoint_status != UX_HOST_CLASS_HID_INTERRUPT_ENDPOINT_ACTIVE) **/
    /** Why direct: Endpoint status only changes via _ux_host_class_hid_periodic_report_start and _ux_host_class_hid_periodic_report_stop; **/
    /**       changing it would require unreasonable hack. **/
    /**************************************************/
