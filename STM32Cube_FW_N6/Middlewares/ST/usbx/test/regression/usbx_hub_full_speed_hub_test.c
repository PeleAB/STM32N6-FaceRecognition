...
static unsigned char framework_full_speed_hub[] = {
    ...
    0x00, /* bDeviceProtocol - full-speed */
...
static DEVICE_INIT_DATA device_init_data = {
    .framework = framework_full_speed_hub,
    .framework_length = sizeof(framework_full_speed_hub),
};

#ifdef CTEST
void test_application_define(void *first_unused_memory)
#else
void usbx_hub_full_speed_hub_test_application_define(void *first_unused_memory)
#endif
{

    /* Inform user.  */
    printf("Running Hub Full Speed Hub Test..................................... ");
