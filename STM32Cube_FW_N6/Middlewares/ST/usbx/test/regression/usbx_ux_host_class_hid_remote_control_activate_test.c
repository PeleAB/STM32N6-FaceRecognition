...
/* In order for callback_register() to fail, there are no input reports. */
...
static VOID error_callback(UINT system_level, UINT system_context, UINT error_code)
{
    ...
    if (error_code != UX_HOST_CLASS_HID_PERIODIC_REPORT_ERROR)
    {
...
#else
void    usbx_ux_host_class_hid_remote_control_activate_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_remote_control_activate Test.............. ");
...
UX_HOST_CLASS_HID_REMOTE_CONTROL   *remote_control;
    ...
    /**************************************************/
    /** Test case: status =  _ux_host_class_hid_periodic_report_start(hid); fails **/
    /**************************************************/

    /* Fails endpoint status. */
    hid -> ux_host_class_hid_interrupt_endpoint_status = 0;
