...
#else
void    usbx_ux_device_stack_endpoint_stall_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_HID_PARAMETER    hid_parameter;
    ...
    /* Inform user.  */
    printf("Running ux_device_stack_endpoint_stall Test......................... ");
...
UX_SLAVE_ENDPOINT       *endpoint;
    ...
    /* Confirm first interfaces are connected. */
    ...
    if (endpoint == UX_NULL)
    {
        printf("ERROR #%d: endpoint not available\n", __LINE__);
        test_control_return(1);
    }
