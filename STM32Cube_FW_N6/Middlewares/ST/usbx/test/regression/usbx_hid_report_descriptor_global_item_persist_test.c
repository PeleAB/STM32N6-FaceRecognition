...
#else
void    usbx_hid_report_descriptor_global_item_persist_test_application_define(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Global Item Persist Test.............. ");
...
UX_HOST_CLASS_HID_FIELD             *report_field;
    ...
    /* Check the second field in the report. */
