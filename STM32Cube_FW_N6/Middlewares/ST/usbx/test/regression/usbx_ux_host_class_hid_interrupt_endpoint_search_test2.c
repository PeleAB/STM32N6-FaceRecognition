...
/**************************************************/
/** Test case: hid -> ux_host_class_hid_interrupt_endpoint -> ux_endpoint_descriptor.bmAttributes & UX_MASK_ENDPOINT_TYPE) == UX_INTERRUPT_ENDPOINT fails in **/
...
static UCHAR device_framework_full_speed[DEVICE_FRAMEWORK_LENGTH_FULL_SPEED] = {
    ...
    /* Endpoint descriptor. Make it non-interrupt for the test (in this case, bulk). */
        0x07, 0x05, 0x82, 0x02, 0x08, 0x00, 0x08
...
#else
void    usbx_ux_host_class_hid_interrupt_endpoint_search_test2_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_interrupt_endpoint_search Test 2....................... ");
