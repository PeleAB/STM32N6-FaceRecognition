...
static UCHAR hid_report_descriptor[] = {
    ...
    0x75, 0x08,                    //   REPORT_SIZE (8)
    0x15, 0x00,                    //   LOGICAL_MINIMUM (0)
    /* Set to something over the maximum amount. */
    0x25, UX_HID_KEYBOARD_KEYS_UPPER_RANGE, //   LOGICAL_MAXIMUM (101)
    0x05, 0x07,                    //   USAGE_PAGE (Keyboard)
    0x19, 0x00,                    //   USAGE_MINIMUM (Reserved (no event indicated))
    /* Set to something over the maximum amount. */
    0x29, UX_HID_KEYBOARD_KEYS_UPPER_RANGE, //   USAGE_MAXIMUM (Keyboard Application)
...
#else
void    usbx_ux_host_class_hid_keyboard_callback_test2_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_keyboard_callback Test 2.................. ");
...
UCHAR                           key;
    ...
    while(1)
    {
        ...
        while (device -> ux_slave_device_state == UX_DEVICE_CONFIGURED)
        {
            ...
            hid_event.ux_device_class_hid_event_buffer[2] = UX_HID_KEYBOARD_KEYS_UPPER_RANGE;
