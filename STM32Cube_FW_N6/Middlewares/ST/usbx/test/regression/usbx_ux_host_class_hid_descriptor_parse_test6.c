...
static UCHAR dummy_configuration_descriptor[] = {
    ...
    /* Interface descriptor */
        0x09, 0x04,
        0x03,  /* Change the interface number to something different than what the HID instance recorded (0x02). */
...
UX_TRANSFER    *transfer_request;
    ...
    case UX_HCD_TRANSFER_REQUEST:
        ...
        /* Is this the second transfer request from descriptor_parse()? */
        if (transfer_request -> ux_transfer_request_requested_length == 34 &&
            ...
            transfer_request -> ux_transfer_request_index == 2)
        {
            ...
            UINT dummy_framework_high_speed_length = ARRAY_COUNT(dummy_configuration_descriptor);
            if(dummy_framework_high_speed_length != transfer_request -> ux_transfer_request_requested_length)
            {
...
#else
void    usbx_ux_host_class_hid_descriptor_parse_test6_application_define(void *first_unused_memory)
#endif
{
...
ALIGN_TYPE                      tmp;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_descriptor_parse Test 6................... ");
    ...
    /**************************************************/
    /** Test case: if (current_interface == hid -> ux_host_class_hid_interface -> ux_interface_descriptor.bInterfaceNumber) fails **/
    /**************************************************/
