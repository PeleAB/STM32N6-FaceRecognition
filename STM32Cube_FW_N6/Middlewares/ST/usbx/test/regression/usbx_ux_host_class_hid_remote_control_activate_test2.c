...
#else
void    usbx_ux_host_class_hid_remote_control_activate_test2_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_remote_control_activate Test 2............ ");
...
UINT                                status;
UX_HOST_CLASS_HID_REMOTE_CONTROL   *remote_control;
...
UX_HOST_CLASS_HID_CLIENT_COMMAND    command;
    ...
    /**************************************************/
    /** Test case: remote_control_instance -> ux_host_class_hid_remote_control_usage_array =  (ULONG *)
                            _ux_utility_memory_allocate(UX_NO_ALIGN, UX_REGULAR_MEMORY,
                                                        UX_HOST_CLASS_HID_REMOTE_CONTROL_USAGE_ARRAY_LENGTH*4); fails **/
    /**************************************************/

    command.ux_host_class_hid_client_command_instance = hid;
    ...
    // dummy_memory_block_first -> ux_memory_block_size = calculate_final_memory_request_size(1, sizeof(UX_HOST_CLASS_HID_REMOTE_CONTROL));
    ...
    /**************************************************/
    /** Test case: remote_control_instance =  (UX_HOST_CLASS_HID_REMOTE_CONTROL *) _ux_utility_memory_allocate(UX_NO_ALIGN, UX_REGULAR_MEMORY,
                                                                                                sizeof(UX_HOST_CLASS_HID_REMOTE_CONTROL)); fails **/
    /**************************************************/
