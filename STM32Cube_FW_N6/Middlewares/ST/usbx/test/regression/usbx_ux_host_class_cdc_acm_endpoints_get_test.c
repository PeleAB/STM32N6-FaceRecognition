...
#define CDC_IFC_DESC_ALL_1(bIfc, bIntIn, bIntInType, bBulkIn, bBulkInType, bBulkOut, bBulkOutType)\
    /* Interface association descriptor. 8 bytes.  */\
    0x08, 0x0b, (bIfc), 0x02, 0x02, 0x02, 0x00, 0x00,\
    /* Communication Class Interface Descriptor Requirement. 9 bytes.   */\
    0x09, 0x04, (bIfc), 0x00, 0x01, 0x02, 0x02, 0x01, 0x00,\
    ...
    0x05, 0x24, 0x01, 0x03, (bIfc + 1),\
    /* Endpoint interrupt in descriptor 7 bytes */\
    0x07, 0x05, (bIntIn), (bIntInType), 0x40, 0x00, 0x10,\
    /* Data Class Interface Descriptor Requirement 9 bytes */\
    0x09, 0x04, (bIfc + 1), 0x00, 0x02, 0x0A, 0x00, 0x00, 0x00,\
    /* Endpoint bulk in descriptor 7 bytes */\
    0x07, 0x05, (bBulkIn), (bBulkInType), 0x40, 0x00, 0x01,\
    /* Endpoint bulk out descriptor 7 bytes */\
    0x07, 0x05, (bBulkOut), (bBulkOutType), 0x40, 0x00, 0x01,
...
#else
void usbx_ux_host_class_cdc_acm_endpoints_get_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                  memory_pointer;
    ...
    printf("Running ux_host_class_cdc_acm_endpoints_get Test.................... ");
...
UX_DEVICE                                          *device;
    ...
    stepinfo(">>>>>>>>>>>>>>>> Test one of EP is not bulk\n");
    ...
    /* Modify bulk out endpoint type. */
    device_framework_full_speed[DEVICE_FRAMEWORK_LENGTH_FULL_SPEED - 4] = 3;
    ...
    if (cdc_acm_host_data)
    {
        ...
        printf("ERROR %d: data interface must not ready\n", __LINE__);
        error_counter ++;
    }
    ...
    /* Modify bulk out endpoint type. */
    device_framework_full_speed[DEVICE_FRAMEWORK_LENGTH_FULL_SPEED - 4] = 2;

    /* Modify bulk in endpoint type. */
    device_framework_full_speed[DEVICE_FRAMEWORK_LENGTH_FULL_SPEED - 11] = 3;
    ...
    /* Modify bulk in endpoint type. */
    device_framework_full_speed[DEVICE_FRAMEWORK_LENGTH_FULL_SPEED - 11] = 2;
