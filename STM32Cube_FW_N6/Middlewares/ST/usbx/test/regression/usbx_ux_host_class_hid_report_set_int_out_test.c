...
#define DEVICE_FRAMEWORK_LENGTH_FULL_SPEED 59
static UCHAR device_framework_full_speed[DEVICE_FRAMEWORK_LENGTH_FULL_SPEED] = {
    ...
    /* Interface descriptor */
        0x09, 0x04, 0x02, 0x00, 0x02, 0x03, 0x00, 0x00,
        0x00,
    ...
    /* Endpoint descriptor (Interrupt OUT) */
        0x07, 0x05, 0x02, 0x03, 0x01, 0x00, 0x08
    };


#define DEVICE_FRAMEWORK_LENGTH_HIGH_SPEED 69
...
static VOID instance_activate_callback(VOID *parameter)
{
    ...
    device_hid = (UX_SLAVE_CLASS_HID *)parameter;
    tx_thread_resume(&tx_demo_thread_slave_simulation);
}
...
#else
void    usbx_ux_host_class_hid_report_set_int_out_test_application_define(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_report_set_int_out Test................... ");
...
UX_SLAVE_TRANSFER           *transfer_request;
    ...
    transfer_request = &device_hid->ux_device_class_hid_interrupt_endpoint->ux_slave_endpoint_next_endpoint->ux_slave_endpoint_transfer_request;
...
UX_HOST_CLASS_HID_REPORT_GET_ID report_id;
    ...
    client_report.ux_host_class_hid_client_report_length = report_id.ux_host_class_hid_report_get_report->ux_host_class_hid_report_byte_length;
