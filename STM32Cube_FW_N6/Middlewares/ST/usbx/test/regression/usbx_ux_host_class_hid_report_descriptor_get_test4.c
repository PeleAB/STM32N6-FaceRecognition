...
#else
void    usbx_ux_host_class_hid_report_descriptor_get_test4_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_report_descriptor_get Test 4.............. ");
...
UX_MEMORY_BLOCK                *original_cache_safe_memory_block = (UX_MEMORY_BLOCK *)_ux_system -> ux_system_memory_byte_pool[UX_MEMORY_BYTE_POOL_CACHE_SAFE] -> ux_byte_pool_start;
    ...
    /**************************************************/
    /** Test case: descriptor =  _ux_utility_memory_allocate(UX_SAFE_ALIGN, UX_CACHE_SAFE_MEMORY, length); fails **/
    /**************************************************/
    ...
    status = _ux_host_class_hid_report_descriptor_get(hid, 3092094);
