...
#else
void    usbx_ux_device_class_storage_prevent_allow_media_removal_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_device_class_storage_prevent_allow_media_removal Test.... ");
    stepinfo("\n");
