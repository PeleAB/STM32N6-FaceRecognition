...
static UCHAR hid_report_descriptor[] = {
    ...
    0xa1, 0x01,                    // COLLECTION (Application)
                                   /* Pop when there are no global states in the stack. */
    0xb4,                          //   POP
    0xc0                           // END_COLLECTION
};
...
#else
void    usbx_hid_report_descriptor_pop_underflow_tag_test_application_define(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Pop Underflow Tag Test................ ");
