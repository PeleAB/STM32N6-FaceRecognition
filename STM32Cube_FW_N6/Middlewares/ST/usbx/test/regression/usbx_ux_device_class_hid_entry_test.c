...
#else
void    usbx_ux_device_class_hid_entry_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_device_class_hid_entry test.............................. ");
...
UX_SLAVE_CLASS_HID             *device_hid;
    ...
    /**************************************************/
    /** Test case: if (command -> ux_slave_class_command_class != UX_DEVICE_CLASS_HID_CLASS). **/
    /** Why direct: an error here would mean the user mismatched [the configuration and interface indices] **/
    /** and [the class] when registering the class; this is a user error. **/
    /**************************************************/

    /* Set up. */
    command.ux_slave_class_command_request   =    UX_SLAVE_CLASS_COMMAND_QUERY;
    command.ux_slave_class_command_class     =   ~UX_DEVICE_CLASS_HID_CLASS;

    status = _ux_device_class_hid_entry(&command);
    ...
    /* Set up. */
    command.ux_slave_class_command_request = 0xdeadbeef;
