...
static UCHAR hid_report_descriptor[] = {
    ...
    0x75, (UX_HOST_CLASS_HID_REPORT_SIZE + 1), //   REPORT_SIZE (UX_HOST_CLASS_HID_REPORT_SIZE + 1)
...
static VOID error_callback(UINT system_level, UINT system_context, UINT error_code)
{
    ...
    if (error_code != UX_HOST_CLASS_HID_REPORT_OVERFLOW &&
...
#else
void    usbx_hid_report_descriptor_report_size_overflow_test_application_define(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Report Size Overflow Test............. ");
