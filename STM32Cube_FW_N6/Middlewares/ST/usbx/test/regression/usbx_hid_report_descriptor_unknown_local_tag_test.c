...
#else
void    usbx_hid_report_descriptor_unknown_local_tag_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Unknown Local Tag Test................ ");
