...
static UCHAR hid_report_descriptor[] = {
    ...
    /* Add an unknown item type. bits 2-3 must be equal to 3. */
    0x0d, 0x00,
...
#else
void    usbx_ux_host_class_hid_report_descriptor_get_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_hid_report_descriptor_get Test....................... ");
