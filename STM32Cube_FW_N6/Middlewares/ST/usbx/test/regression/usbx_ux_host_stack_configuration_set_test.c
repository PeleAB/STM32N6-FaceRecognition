...
static UX_TEST_SETUP _b_hnp_support = {0x00,0x03,UX_OTG_FEATURE_A_HNP_SUPPORT,0x0000};

static UX_TEST_HCD_SIM_ACTION b_hnp_support_request_err[] = {
/* function, request to match,
   port action, port status,
   request action, request EP, request data, request actual length, request status,
   status, additional callback,
   no_return */
{   UX_HCD_TRANSFER_REQUEST, &_b_hnp_support,
        UX_FALSE, 0,
        UX_TEST_SETUP_MATCH_REQ_V, 0, UX_NULL, 0, UX_ERROR,
        UX_ERROR, ux_test_hcd_entry_invoked},
{   UX_HCD_TRANSFER_REQUEST, &_b_hnp_support,
        UX_FALSE, 0,
        UX_TEST_SETUP_MATCH_REQ_V, 0, UX_NULL, 0, UX_ERROR,
        UX_ERROR, ux_test_hcd_entry_invoked},
...
static UX_TEST_HCD_SIM_ACTION b_hnp_support_request_ok[] = {
/* function, request to match,
   port action, port status,
   request action, request EP, request data, request actual length, request status,
   status, additional callback,
...
{   UX_HCD_TRANSFER_REQUEST, &_b_hnp_support,
        UX_FALSE, 0,
        UX_TEST_SETUP_MATCH_REQ_V, 0, UX_NULL, 0, UX_SUCCESS,
...
#else
void    usbx_ux_host_stack_configuration_set_test_application_define(void *first_unused_memory)
#endif
{
...
UX_SLAVE_CLASS_DPUMP_PARAMETER  parameter;
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_set Test........................ ERROR #1\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_set Test........................ ERROR #2\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_set Test........................ ERROR #3\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_set Test........................ ERROR #5\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_set Test........................ ERROR #6\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_set Test........................ ERROR #7\n");
        test_control_return(1);
    }
    ...
    if (status != UX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_set Test........................ ERROR #4\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_set Test........................ ERROR #8\n");
        test_control_return(1);
    }
    ...
    if (status != TX_SUCCESS)
    {
        ...
        printf("Running ux_host_stack_configuration_set Test........................ ERROR #9\n");
        test_control_return(1);
    }
}
...
UX_HCD           *hcd;
    ...
    /* Inform user.  */
    printf("Running ux_host_stack_configuration_set Test........................ ");
    ...
    /* Simulate OTG HNP Support on HCD. */
    hcd =  &_ux_system_host -> ux_system_host_hcd_array[0];
#ifdef UX_OTG_SUPPORT
    hcd -> ux_hcd_otg_capabilities = UX_HCD_OTG_CAPABLE;
#endif
    test_error_counter = 0;
    ux_test_hcd_sim_host_set_actions(b_hnp_support_request_err);

    /* Connect, with OTG descriptor. */
    ...
    if (test_error_counter == 0)
    {
        ...
        printf("ERROR #%d: Expect a_hnp_support request\n", __LINE__);
        error_counter ++;
    }
    if (configuration->ux_configuration_otg_capabilities)
    {

        printf("ERROR #%d: Expect no OTG since a_hnp_support request fail\n", __LINE__);
        error_counter ++;
    }

    /* SetConfiguration but device connected to hub.  */
    configuration->ux_configuration_otg_capabilities |= UX_OTG_HNP_SUPPORT;
    configuration->ux_configuration_device->ux_device_parent = device;
    status = _ux_host_stack_configuration_set(configuration);
    if (status != UX_SUCCESS)
    {
        printf("ERROR #%d: fail to set configuration (no SNP request)\n", __LINE__);
        error_counter ++;
    }
    configuration->ux_configuration_device->ux_device_parent = UX_NULL;

    /* Simulate OTG HNP Support on HCD. */
    UX_DEVICE_HCD_GET(configuration->ux_configuration_device)->ux_hcd_otg_capabilities |= UX_HCD_OTG_CAPABLE;

    test_error_counter = 0;
    ux_test_hcd_sim_host_set_actions(b_hnp_support_request_ok);
    ...
    if (!configuration->ux_configuration_otg_capabilities)
    {
        ...
        printf("ERROR #%d: Expect OTG since a_hnp_support request pass\n", __LINE__);
        error_counter ++;
    }
#endif
