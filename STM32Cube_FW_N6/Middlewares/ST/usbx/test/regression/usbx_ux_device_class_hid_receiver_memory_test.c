...
#else
void    usbx_ux_device_class_hid_receiver_memory_test_application_define(void *first_unused_memory)
#endif
{
...
ULONG                                               test_n;
    ...
    /* Inform user.  */
    printf("Running ux_device_class_hid Receiver Memory test ................... ");
    stepinfo("\n");
    ...
    hid_mouse_parameter.ux_device_class_hid_parameter_receiver_initialize                = ux_device_class_hid_receiver_initialize;
    hid_mouse_parameter.ux_device_class_hid_parameter_receiver_event_max_number          = 8;
    hid_mouse_parameter.ux_device_class_hid_parameter_receiver_event_max_length          = 32;

    hid_keyboard_parameter.ux_device_class_hid_parameter_receiver_initialize             = ux_device_class_hid_receiver_initialize;
    hid_keyboard_parameter.ux_device_class_hid_parameter_receiver_event_max_number       = 8;
    hid_keyboard_parameter.ux_device_class_hid_parameter_receiver_event_max_length       = 32;

    hid_remote_control_parameter.ux_device_class_hid_parameter_receiver_initialize       = ux_device_class_hid_receiver_initialize;
    hid_remote_control_parameter.ux_device_class_hid_parameter_receiver_event_max_number = 8;
    hid_remote_control_parameter.ux_device_class_hid_parameter_receiver_event_max_length = 32;
#endif
