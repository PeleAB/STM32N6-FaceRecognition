...
#else
void    usbx_hid_report_descriptor_max_usages_test(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Max Usages Test....................... ");
...
UINT                                i;
    ...
    /* Make sure the usages are correct. */
    for (i = 0; i < 1024; i++)
    {
        if (report_field -> ux_host_class_hid_field_usages[i] != (0x00010000 | i))
        {
