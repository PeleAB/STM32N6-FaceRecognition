...
#else
void    usbx_ux_host_class_storage_media_recovery_sense_get_test_application_define(void *first_unused_memory)
#endif
{
...
CHAR *                          memory_pointer;
    ...
    /* Inform user.  */
    printf("Running ux_host_class_storage_media_recovery_sense_get Test......... ");
    stepinfo("\n");
...
ULONG                                       rfree, cfree;
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_media_recovery_sense_get - UX_SUCCESS\n");
    status = _ux_host_class_storage_media_recovery_sense_get(storage);
    if (status != UX_SUCCESS)
    {
        printf("ERROR #%d, code 0x%x\n", __LINE__, status);
        test_control_return(1);
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_media_recovery_sense_get - RBC\n");
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_media_recovery_sense_get - UX_MEMORY_INSUFFICIENT\n");
    ...
    stepinfo(">>>>>>>>>>>>>>> ux_host_class_storage_media_recovery_sense_get - transfer error\n");
