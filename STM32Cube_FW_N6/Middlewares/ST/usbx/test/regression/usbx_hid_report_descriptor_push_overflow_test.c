...
static UCHAR hid_report_descriptor[] = {
    ...
    0xa1, 0x01,                    // COLLECTION (Application)
                                   /* Push more than the allowable states (4 is the max). */
    0xa4,                          //   PUSH
    0xa4,                          //   PUSH
    0xa4,                          //   PUSH
    0xa4,                          //   PUSH
...
#else
void    usbx_hid_report_descriptor_push_overflow_tag_test_application_define(void *first_unused_memory)
#endif
{
...
UINT                            descriptor_size = HID_REPORT_LENGTH;
    ...
    /* Inform user.  */
    printf("Running HID Report Descriptor Push Overflow Tag Test................ ");
