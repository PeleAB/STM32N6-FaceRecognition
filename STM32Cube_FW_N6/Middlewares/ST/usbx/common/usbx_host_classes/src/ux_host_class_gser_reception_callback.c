...
ULONG                           interface_index;
        ...
        gser_reception -> ux_host_class_gser_reception_data_buffer + gser_reception -> ux_host_class_gser_reception_data_buffer_size)
    {
        ...
        if (gser_reception -> ux_host_class_gser_reception_data_tail ==  gser_reception -> ux_host_class_gser_reception_data_buffer)
        {
            ...
            gser_reception -> ux_host_class_gser_reception_data_head +=  gser_reception -> ux_host_class_gser_reception_block_size;
