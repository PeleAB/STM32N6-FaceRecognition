...
UX_HOST_CLASS_PROLIFIC_RECEPTION     *prolific_reception;
        ...
        prolific_reception -> ux_host_class_prolific_reception_data_buffer + prolific_reception -> ux_host_class_prolific_reception_data_buffer_size)
    {
        ...
        if (prolific_reception -> ux_host_class_prolific_reception_data_tail ==  prolific_reception -> ux_host_class_prolific_reception_data_buffer)
        {
            ...
            prolific_reception -> ux_host_class_prolific_reception_data_head +=  prolific_reception -> ux_host_class_prolific_reception_block_size;
    ...
    /* Update the next buffer for reception.  */
