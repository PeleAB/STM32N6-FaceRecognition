...
UCHAR *         control_buffer;
    ...
    transfer_request -> ux_transfer_request_function =          UX_HOST_CLASS_VIDEO_GET_MIN;
    ...
    transfer_request -> ux_transfer_request_function =  UX_HOST_CLASS_VIDEO_GET_MAX;
    ...
    transfer_request -> ux_transfer_request_function =  UX_HOST_CLASS_VIDEO_GET_RES;
    ...
    if ((status == UX_SUCCESS) && (transfer_request -> ux_transfer_request_actual_length == 2))
    {
        ...
        video_control -> ux_host_class_video_control_res =  (LONG)(SHORT)_ux_utility_short_get(control_buffer);
    }
