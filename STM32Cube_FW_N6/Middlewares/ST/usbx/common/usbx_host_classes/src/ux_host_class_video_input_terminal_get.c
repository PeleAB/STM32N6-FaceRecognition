...
UX_HOST_CLASS_VIDEO_INPUT_TERMINAL_DESCRIPTOR   input_terminal_descriptor;
            ...
            case UX_HOST_CLASS_VIDEO_CS_INTERFACE:
                ...
                if ((interface_found == UX_TRUE) && (descriptor_subtype == UX_HOST_CLASS_VIDEO_VC_INPUT_TERMINAL))
                {
                    ...
                    _ux_utility_descriptor_parse(descriptor, _ux_system_class_video_input_terminal_descriptor_structure,
                                                 UX_HOST_CLASS_VIDEO_INPUT_TERMINAL_DESCRIPTOR_ENTRIES, (UCHAR *) &input_terminal_descriptor);
