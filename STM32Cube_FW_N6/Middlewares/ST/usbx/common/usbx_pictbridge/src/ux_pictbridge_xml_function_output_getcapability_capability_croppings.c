...
UINT    status;
    ...
    /* Get the array of croppings supported by this client.  */
    status = _ux_pictbridge_array_element_to_array_hexa(xml_parameter, (ULONG *) &pictbridge -> ux_pictbridge_dpsclient.ux_pictbridge_devinfo_croppings);
