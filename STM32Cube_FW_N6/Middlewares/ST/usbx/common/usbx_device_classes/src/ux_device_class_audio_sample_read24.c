...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _ux_device_class_audio_sample_read24                PORTABLE C      */
/*                                                           6.2.1        */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function reads 24-bit sample value from the Audio class.       */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
...
ULONG                       next_frame_sample;
    ...
    if (buffer)
        *buffer = sample_ptr[0] + ((ULONG)sample_ptr[1] << 8) + ((ULONG)sample_ptr[2] << 16);

    /* Update sample read state.  */
    next_frame_sample = stream -> ux_device_class_audio_stream_access_pos -> ux_device_class_audio_frame_pos + 3;
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _uxe_device_class_audio_sample_read24                PORTABLE C     */
/*                                                            6.2.1       */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Chaoqiong Xiao, Microsoft Corporation                               */
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function checks errors in reading 24-bit sample function call. */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
/*    stream                                Address of audio stream       */
...
/*  CALLS                                                                 */
/*                                                                        */
/*    _ux_device_class_audio_sample_read24   Read 24-bit sample           */
/*                                                                        */
/*  CALLED BY                                                             */
/*                                                                        */
/*    Application                                                         */
                                         ...
                                         ULONG *buffer)
{
    ...
    /* Read 24-bit sample.  */
    return(_ux_device_class_audio_sample_read24(stream, buffer));
}
